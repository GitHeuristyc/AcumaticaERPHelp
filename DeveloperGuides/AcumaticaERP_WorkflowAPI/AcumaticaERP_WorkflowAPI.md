...
| Copyright6                                                                                         |  |
|----------------------------------------------------------------------------------------------------|--|
| Getting Started with Workflow API: General Information7                                            |  |
| Company Story and Customization Description 9                                                      |  |
| Business Process Overview10                                                                        |  |
...
| Test Instance for Workflow Customization: To Deploy a Test Instance17                              |  |
...
| Screen Configuration: General Information22                                                        |  |
| Screen Configuration: To Prepare a Screen Configuration for a Form Without a Predefined Workflow24 |  |
| Step 1: Defining the Workflow Class25                                                              |  |
| Step 2: Defining the Set of States of the Workflow26                                               |  |
| Step 3: Overriding the Configure Method 27                                                         |  |
| Screen Configuration: To Prepare a Screen Configuration with a Predefined Workflow28               |  |
| Screen Configuration: Restrictions of the Configure Method 30                                      |  |
| Defining Workflow States 33                                                                        |  |
| Workflow States: General Information 33                                                            |  |
| Workflow States: Configuration of Field States 35                                                  |  |
| Workflow States: Configuration of Actions 36                                                       |  |
| Workflow States: To Define a Workflow State38                                                      |  |
| Workflow States: Tracking of Changes in States40                                                   |  |
| Implementing Workflow Actions41                                                                    |  |
| Workflow Actions: General Information 41                                                           |  |
| Workflow Actions: Configuration of Actions 43                                                      |  |
| Workflow Actions: Appearance of Buttons and Commands 44                                            |  |
| Workflow Actions: Persisting Options45                                                             |  |
| Workflow Actions: Mass Processing Actions 46                                                       |  |
| Workflow Actions: Action's Behavior47                                                              |  |
| Workflow Actions: Opening of a Side Panel48                                                        |  |
| Workflow Actions: Categories of the More Menu50                                                    |  |
| Workflow Actions: To Implement a Simple Action 51                                                  |  |

#### Contents | **3**

| Step 1: Implementing the Action in the Graph 52                                  |  |
|----------------------------------------------------------------------------------|--|
| Step 2: Defining a Category for the Action53                                     |  |
| Step 3: Adding the Action to the Workflow53                                      |  |
| Workflow Actions: To Implement an Action with Field Assignments 54               |  |
| Step 1: Adding and Configuring the Action55                                      |  |
| Step 2: Adding a Workflow State and a Transition 55                              |  |
| Step 3: Testing the Field Assignment 56                                          |  |
| Workflow Actions: To Configure the Conditional Appearance of the Action 56       |  |
| Step 1: Defining the Graph Action 57                                             |  |
| Step 2: Configuring the Conditional Appearance of the Button 60                  |  |
| Step 3: Testing the Action 61                                                    |  |
| Workflow Actions: Order of Field Assignments62                                   |  |
| Implementing Transitions 64                                                      |  |
| Transitions: General Information64                                               |  |
| Transitions: To Implement a Transition Triggered by an Action 65                 |  |
| Transitions: Transition Groups68                                                 |  |
| Transitions: To Implement a Group of Transitions 68                              |  |
| Step 1: Adding a Condition 69                                                    |  |
| Step 2: Adding the PendingPayment Workflow State (Self-Guided Exercise) 70       |  |
| Step 3: Grouping Transitions and Adding Conditions to Transitions70              |  |
| Step 4 (Optional): Specifying the Order of Transitions71                         |  |
| Step 5: Testing Transitions With Conditions 72                                   |  |
| Defining Conditions 73                                                           |  |
| Conditions: General Information 73                                               |  |
| Implementing Workflow Dialog Boxes 75                                            |  |
| Workflow Dialog Boxes: General Information 75                                    |  |
| Workflow Dialog Boxes: Configuration of Fields76                                 |  |
| Workflow Dialog Boxes: Configuration of the Layout78                             |  |
| Workflow Dialog Boxes: To Implement a Transition with a Dialog Box 79            |  |
| Step 1: Defining a Workflow Dialog Box79                                         |  |
| Step 2: Defining the Action That Opens the Workflow Dialog Box80                 |  |
| Step 3: Defining the Workflow State and the Transition (Self-Guided Exercise) 81 |  |
| Step 4: Testing the Assign Action81                                              |  |
| Configuring Field States  83                                                     |  |
| Field States: General Information83                                              |  |
| Field States: Levels of Configuration 84                                         |  |

| Implementing Workflow Events86                                        |  |
|-----------------------------------------------------------------------|--|
| Workflow Events: General Information 86                               |  |
| Workflow Events: To Use an Existing Event89                           |  |
| Step 1: Exploring the Acumatica ERP Source Code 90                    |  |
| Step 2: Preparing the Project for Debugging 90                        |  |
| Step 3: Exploring and Debugging the Code 92                           |  |
| Step 4: Defining the Paid Workflow State (Self-Guided Exercise) 94    |  |
| Step 5: Defining the Workflow Event Handler 95                        |  |
| Step 6: Overriding the PerformPersist Method 96                       |  |
| Step 7: Testing the Transition 97                                     |  |
| Workflow Events: To Create a Workflow Event 98                        |  |
| Step 1: Creating a Custom Field 99                                    |  |
| Step 2: Deriving the Value of the Field 100                           |  |
| Step 3: Exploring the Acumatica ERP Source Code 101                   |  |
| Step 4: Declaring the Workflow Event102                               |  |
| Step 5: Firing the Event 103                                          |  |
| Step 6: Testing the Transition 105                                    |  |
| Customizing a Predefined Workflow107                                  |  |
| Workflow Customization: General Information 107                       |  |
| Workflow Customization: To Add an Action to an Existing Workflow 108  |  |
| Step 1: Adding a Graph Action108                                      |  |
| Step 2: Adding a Workflow Extension109                                |  |
| Step 3: Defining a Workflow Action 110                                |  |
| Step 4: Testing the New Action112                                     |  |
| Implementing Composite States 113                                     |  |
| Composite Workflow States: General Information 113                    |  |
| Composite Workflow States: To Update a Composite State 116            |  |
| Step 1: Investigating the Source Code 117                             |  |
| Step 2: Extending the ARDocStatus class118                            |  |
| Step 3: Adding the ApproveDiscount Action 118                         |  |
| Step 4: Adding the Skip Condition 119                                 |  |
| Step 5: Adding the Postponed Workflow State to the Composite State119 |  |
| Step 6: Adding the Transition 120                                     |  |
| Step 7: Testing the Transition 121                                    |  |
| Defining Action Sequences122                                          |  |
| Action Sequences: General Info 122                                    |  |

#### Contents | **5**

| Action Sequences: To Define an Action Sequence124                                                |  |
|--------------------------------------------------------------------------------------------------|--|
| Defining Workflows with a Workflow Identifying Field129                                          |  |
...
| Step 2: Specifying the Workflow-Identifying Field in the Workflow 134                            |  |
| Step 3: Adding a Workflow for the Specific Value of the Workflow-Identifying Field135            |  |
| Step 4: Testing the Workflow 137                                                                 |  |
| Using Workflow-Identifying Fields of the Second Level 138                                        |  |
| Workflow-Identifying Fields of the Second Level: General Information138                          |  |
| Workflow-Identifying Fields of the Second Level: To Define a Workflow 140                        |  |
...
## <span id="page-6-0"></span>**Getting Started with Workflow API: General Information**
...
• By using automation steps.

This functionality has been deprecated since 2023 R1.

• Through complex logic in graph code. Developers used a set of flags to track the record status and implemented event handlers, such as RowSelected. In the event handlers, they changed the properties of different elements of the screen, such as fields and actions, depending on the flags' values.
...
For details on defining states, see *[Defining Workflow States](#page-32-2)*. For details on defining transitions, see *[Implementing](#page-63-2) [Transitions](#page-63-2)*.

#### **Actions and Fields**

You can configure action and field properties for a form and its workflows at the same time, depending on the conditions specified for the form when a record is in any workflow state or in a particular workflow state. For details on actions and their properties, see *[Implementing Workflow Actions](#page-40-2)*.

#### **Conditions**

Conditions can be used in the properties of actions and fields at the form level (that is, for all workflows of a particular form). At the workflow level, conditions can be used to determine whether transitions are performed. Also, conditions can be used to determine whether actions are performed automatically. For details on defining and using conditions, see *[Defining Conditions](#page-72-2)*.
...
The *T210 Customized Forms and Master-Detail Relationship* course covers the creation of another maintenance form, Services and Prices (RS203000), and the customization of the *[Stock Items](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=77786a70-1f1e-4d63-ad98-96f98e4fcb0e)* (IN202500) form of Acumatica ERP. The Services and Prices (RS203000) form provides users with the ability to define and maintain the price for each repair service the company provides. The *[Stock Items](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=77786a70-1f1e-4d63-ad98-96f98e4fcb0e)* (IN202500) form has been customized to give users the ability to mark particular stock items as repair items—that is, items that are used for repair services.
...
In the activities of this guide, you will implement a workflow on the Repair Work Orders (RS301000) form. The workflow will change the state of a record created on the form—that is, the status of the repair work order and the related properties of the fields and actions on the form. You will also customize the workflow on the *[Invoices](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=0acc9738-f141-4ea0-a2be-f34ea9d1b63a)* (SO303000) form by doing the following:
...
As specified on the Repair Services (RS201000) form, the *Battery Replacement* service does not require a prepayment. The total cost of the order must be paid in full aer the repair is completed.
...
## <span id="page-9-1"></span><span id="page-9-0"></span>**Business Process Overview**
...
When work on the order is completed, a user will complete the assigned order by clicking the **Complete** button, which will give the order the *Completed* status. Aer that, a user creates an invoice for the order. When the invoice is fully paid, the system will assign the *Paid* status to the repair work order.
...
## <span id="page-12-1"></span><span id="page-12-0"></span>**Customization Description**
...
| <b>Repair Work Orders</b><br>000004 - Liquid Damage                                     |                                                                                                          | $\Box$ NOTES              | <b>CUSTOMIZATION</b><br>TOOLS $\star$<br><b>FILES</b>                           |
|-----------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------|---------------------------|---------------------------------------------------------------------------------|
| 周<br>$\Box$<br>面<br>$\bigcirc$ $\cdot$<br>$\pm$<br>$\Omega$<br>$\overline{\phantom{0}}$ | $\mathcal{H}$<br><b>HOLD</b><br>$\overline{\mathsf{K}}$<br>$\left\langle \right\rangle$<br>$\rightarrow$ | <b>ASSIGN</b><br>$\cdots$ |                                                                                 |
| Order Nbr.:<br>$\circ$<br>000004                                                        | Customer ID:<br>C000000001 - Jersey Central Office E                                                     | Processing                | $\lambda$                                                                       |
| Ready for Assignment<br>Status:                                                         | Service:<br>LIQUIDDAMAGE - Liquid Damage                                                                 | Remove Hold               |                                                                                 |
| * Date Created:<br>12/23/2021 -                                                         | Device:<br>NOKIA3310 - Nokia 3310                                                                        | Hold                      |                                                                                 |
| Date Completed:                                                                         | Assignee:                                                                                                | Assign $\bullet$          |                                                                                 |
| Medium<br>Priority:<br>$\overline{\phantom{a}}$                                         | Description:<br>Liquid Damage, Nokia 3310                                                                | Complete                  |                                                                                 |
| <b>REPAIR ITEMS</b><br>LABOR                                                            |                                                                                                          | Create Invoice            |                                                                                 |
| $\boxed{\mathbf{x}}$<br>$\left  \rightarrow \right $<br>$\times$<br>$\theta$            |                                                                                                          |                           |                                                                                 |
| <b>Repair Item Type</b><br>ם<br><b>Inventory ID</b><br>81                               | <b>Description</b>                                                                                       | Price                     |                                                                                 |
| <b>BAT3310</b><br>0<br>D<br>Battery                                                     | Battery for Nokia 3310                                                                                   | 20.00                     |                                                                                 |
| Battery<br><b>BAT3310EX</b><br>0<br>ם                                                   | Extended Battery for Nokia 3310                                                                          | 30.00                     |                                                                                 |
|                                                                                         |                                                                                                          |                           |                                                                                 |
|                                                                                         |                                                                                                          |                           |                                                                                 |
|                                                                                         |                                                                                                          |                           |                                                                                 |
|                                                                                         |                                                                                                          |                           | $\mathbb{R}$<br>$\rightarrow$<br>>1<br>$\overline{\left\langle \right\rangle }$ |

*Figure: The resulting form*

#### **Customized Workflow for the Invoices Form**

To continue working on a repair work order aer an invoice has been prepaid, a user needs an action that opens the corresponding repair work order from the *[Invoices](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=0acc9738-f141-4ea0-a2be-f34ea9d1b63a)* (SO303000) form. Accordingly, you need to customize the predefined workflow of that form. The command corresponding to the action should be named**View Repair Work Order** and should be displayed on the More menu under the **Repair Work Orders** category, as shown in the following screenshot.

| <b>Invoices</b><br>Invoice INV000051 - Jersey Central Office Equip                                                                                                                                                                                                                                                                                   |                                                                                                  | <b>P</b> NOTES                                                                                                                                                                                                                                                           | <b>CUSTOMIZATION</b><br>TOOLS $\blacktriangleright$<br><b>ACTIVITIES</b><br><b>FILES</b> |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------|
| $\circ$<br>罰<br>$\Box$<br>间<br>$\Omega$<br>$\pm$<br>$\checkmark$<br>$\leftarrow$                                                                                                                                                                                                                                                                     | $\overline{\mathsf{K}}$<br>$\geq$<br>$\overline{\phantom{0}}$<br>$\rightarrow$<br>$\cdots$       |                                                                                                                                                                                                                                                                          |                                                                                          |
| Customer:<br>Type:<br>Invoice<br>$\checkmark$<br>Reference Nbr.:<br>INV000051 Q<br>Terms:<br>* Due Date:<br>Status:<br>Open<br>Date:<br>4/28/2025<br>* Cash Discount<br>Post Period:<br>04-2025<br>Customer Ord<br>Project/Contract: X - Non-Project Code.<br>Description:<br><b>TAXES</b><br><b>FREIGHT</b><br><b>DETAILS</b><br><b>COMMISSIONS</b> | C000000001 - Jersey<br>30D - Net 30 days<br>5/28/2025<br>自<br>4/28/2025<br>自<br><b>FINANCIAL</b> | Printing and Emailing<br>Processing<br><b>Remove Hold</b><br><b>Print Invoice</b><br>Hold<br><b>Email Invoice</b><br>Release<br>Other<br>Pay<br><b>Recalculate Prices</b><br>Corrections<br>Reports<br><b>Correct Invoice</b><br><b>AR Edit</b><br><b>Cancel Invoice</b> | $\sim$                                                                                   |
| $\mathscr{Q}$<br>$\times$<br><b>ADD ITEMS</b><br>ADD ORDER<br>Õ                                                                                                                                                                                                                                                                                      | ADD SO LINE                                                                                      | Write Off<br>Repair Work Orders<br><b>Reclassify GL Batch</b><br><b>View Repair Work Order</b>                                                                                                                                                                           |                                                                                          |
| $\Box$<br>圄<br>0<br><b>Shipment Nbr.</b><br>*Branch<br>$\Box$<br>$\mathbf{0}$<br>SOFT<br>0<br>n<br>SOFT                                                                                                                                                                                                                                              | Order<br>Order Nbr.<br>Type                                                                      | Approval<br><b>Credit Hold</b><br><b>Remove Credit Hold</b>                                                                                                                                                                                                              | Quantity UOM<br>1.00<br>PIECE<br>1.00 PIECE                                              |
| $\lambda$<br>$\mathbb{K}$<br>$\rightarrow$<br>On Hand -2.00 PIECE, Available -2.00 PIECE, Available for Shipping -2.00 PIECE<br>$\langle$                                                                                                                                                                                                            |                                                                                                  |                                                                                                                                                                                                                                                                          |                                                                                          |

*Figure: The View Repair Work Order action*

To implement this task, you will extend the graph to define the action and customize the predefined workflow of the *[Invoices](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=0acc9738-f141-4ea0-a2be-f34ea9d1b63a)* (SO303000) form. In the customized workflow, you will do the following:

- Define the workflow action
- Define the action category
- Add the action to the workflow state

## <span id="page-16-4"></span><span id="page-16-0"></span>**Preparing an Instance for Workflow Customization**

In this chapter, you will learn how to configure an instance of Acumatica ERP for testing the activities of this guide.

## <span id="page-16-1"></span>**Test Instance for Workflow Customization: General Information**
...
Suppose that you need to perform customization tasks for the Smart Fix company, as described in *[Company](#page-8-1) [Story and Customization Description](#page-8-1)*. You need to deploy an instance of Acumatica ERP with the *PhoneRepairShop* customization project published.
...
- 5. Install Acumatica ERP. On the Main Soware Configuration page of the Acumatica ERP Setup wizard, select the **Install Acumatica ERP** and **Install DebuggerTools** check boxes.

If you have already installed Acumatica ERP without debugger tools, you should remove Acumatica ERP and install it again with the **Install DebuggerTools** check box selected. The reinstallation of Acumatica ERP does not affect existing Acumatica ERP instances. You can also install the Acumatica ERP Tools separately. For details, see *[Acumatica ERP Installation On-](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=8c7eb99e-31ca-4c1c-8f44-d6960080a450)Premises: To Install the [Acumatica](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=8c7eb99e-31ca-4c1c-8f44-d6960080a450) ERP Tools (Optional)*.

#### **Step 2: Deploying the Instance**

To perform customization for the Smart Fix company as described in *[Company Story and Customization Description](#page-8-1)*, you need deploy an instance of Acumatica ERP and publish the customization project prepared for the *T270 Workflow API* training course on the instance.
...
- 1. Open the Acumatica ERP Configuration wizard, and do the following:
  ...
  - c. On the **Database Configuration** page, make sure the name of the database is SmartFix\_T270.
...
## <span id="page-18-2"></span><span id="page-18-0"></span>**Test Instance for Workflow Customization: To Turn On Workflow Validation**
...
## <span id="page-18-3"></span><span id="page-18-1"></span>**Test Instance for Workflow Customization: To Configure the Instance**

Based on the *[Customization Description](#page-12-1)*, you need to configure the instance to be able to test the logic you implement while completing the activities in this guide.

#### **Story**

In the Smart Fix company, there are no shipments or sales orders associated with repair work orders. Therefore, you need to configure Acumatica ERP so that during the creation of an SO invoice on the *[Invoices](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=0acc9738-f141-4ea0-a2be-f34ea9d1b63a)* (SO303000) form, stock items can be added directly to the SO invoice without sales orders and shipments being processed.

Aer you perform the customization tasks, you will be testing your changes, including the **Create Invoice** button or command (which corresponds to the CreateInvoice action that you will create) of the Repair Work Orders (RS301000) form. If you click the button multiple times during testing, you may run into an issue with insufficient stock items in a warehouse. When an SO invoice is released, the quantity of stock items included in the invoice is checked, and if there are not enough stock items in a warehouse, an invoice cannot be created. You need to prevent this issue from occurring.

#### **Process Overview**

You will enable the *Advanced SO Invoices* feature on the *[Enable/Disable Features](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=c1555e43-1bc5-4f6f-ba9d-b323f94d8a6b)* (CS100000) form to make it possible to process repair work orders.

On the *[Item Classes](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=80a3301b-4eb2-4ce2-94c5-0407c786a0f1)* (IN201000) form, you will also change the *STOCKITEM* item class to allow negative quantities for the stock items. This will prevent possible issues during the testing of the **Create Invoice** action.

You will also specify accounts receivable preferences.

#### **Step 1: Turning on the Feature**

To turn on the feature, on the *[Enable/Disable Features](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=c1555e43-1bc5-4f6f-ba9d-b323f94d8a6b)* (CS100000) form, do the following:
...
- 1. On the *[Item Classes](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=80a3301b-4eb2-4ce2-94c5-0407c786a0f1)* (IN201000) form, in the **Item ClassTree**, select *STOCKITEM*. All the stock items used in the activities of this guide belong to this class.All the stock items used in the activities of this training course belong to this class.
- 2. On the **General** tab (**GeneralSettings** section), select the **Allow Negative Quantity** check box, as shown in the following screenshot.

| Item Classes                         |                                  |                                                |              |                         |                 |                      |                    | <b>TH NOTES</b> | <b>ACTIVITIES</b> | <b>FILES</b> | <b>CUSTOMIZATION</b> | TOOLS $\sim$ |
|--------------------------------------|----------------------------------|------------------------------------------------|--------------|-------------------------|-----------------|----------------------|--------------------|-----------------|-------------------|--------------|----------------------|--------------|
| B<br>$\Omega$ +<br>偷                 | D v K ( ) ) …                    |                                                |              |                         |                 |                      |                    |                 |                   |              |                      |              |
| <b>Item Class Tree</b><br>$\epsilon$ |                                  |                                                |              |                         |                 |                      |                    |                 |                   |              |                      |              |
| - E LABOR***** Labor                 | * Class ID:                      | STOCKITEM - Stock item<br>$\varphi$            |              |                         |                 |                      |                    |                 |                   |              |                      |              |
| - E NSTOCKITEM Non-stock item        | Description:                     | Stock item                                     |              |                         |                 |                      |                    |                 |                   |              |                      |              |
| STOCKITEM* Stock item                | <b>GENERAL</b>                   | <b>RESTRICTION GROUPS</b><br><b>ATTRIBUTES</b> |              |                         |                 |                      |                    |                 |                   |              |                      |              |
|                                      |                                  |                                                |              |                         |                 |                      |                    |                 |                   |              |                      |              |
|                                      | <b>GENERAL SETTINGS</b>          |                                                |              | <b>UNIT OF MEASURE</b>  |                 |                      |                    |                 |                   |              |                      |              |
|                                      |                                  | Stock Item                                     |              | * Base Unit:            | PIECE           | $\circ$<br>$\Lambda$ | Oivisible Unit     |                 |                   |              |                      |              |
|                                      |                                  | Allow Negative Quantity                        |              | * Sales Unit:           | PIECE           | $\mathcal{Q}$        | Oivisible Unit     |                 |                   |              |                      |              |
|                                      | Item Type:                       | <b>Finished Good</b>                           | $\checkmark$ | * Purchase Unit:        | PIECE           | $\circ$              | Oivisible Unit     |                 |                   |              |                      |              |
|                                      | Valuation Method:                | Average                                        | $\checkmark$ | Ò<br>$^{+}$<br>$\times$ |                 |                      |                    |                 |                   |              |                      |              |
|                                      | Tax Category:                    | <b>EXEMPT - Exempt</b>                         | $\rho$       | *From                   |                 |                      | Conversion To Unit |                 |                   |              |                      |              |
|                                      | Posting Class:                   | STOCKITEM - Stock item                         | $\rho$       | Unit                    | Multiply/Divide |                      | Factor             |                 |                   |              |                      |              |
|                                      | Post Cost to Expenses  Purchases |                                                |              |                         |                 |                      |                    |                 |                   |              |                      |              |
|                                      | Price Class:                     |                                                | 00           |                         |                 |                      |                    |                 |                   |              |                      |              |
|                                      | Default Warehouse:               |                                                | $\rho$       |                         |                 |                      |                    |                 |                   |              |                      |              |
|                                      | * Availability Calculation       | <b>STOCKITEM</b>                               | 00           |                         |                 |                      |                    |                 |                   |              |                      |              |
|                                      | Country Of Origin:               |                                                | Q            | <b>PRICE MANAGEMENT</b> |                 |                      |                    |                 |                   |              |                      |              |
|                                      | <b>SHIPPING THRESHOLDS</b>       |                                                |              | Price Workgro           |                 |                      |                    |                 |                   |              |                      |              |
|                                      | Undership Threshold (%):         |                                                |              | Price Manager:          |                 |                      | $\circ$<br>$\rho$  |                 |                   |              |                      |              |
|                                      |                                  | 100.00                                         |              |                         |                 |                      |                    |                 |                   |              |                      |              |
|                                      | Overship Threshold (%):          | 100.00                                         |              | Min. Markup %:          | 0.00            |                      |                    |                 |                   |              |                      |              |
|                                      |                                  |                                                |              | Markup %:               | 0.000000        |                      |                    |                 |                   |              |                      |              |
|                                      |                                  |                                                |              |                         |                 |                      |                    |                 |                   |              |                      |              |
...
- 2. On the **Data EntrySettings** section of the **General** tab, clear the**Validate DocumentTotals on Entry** and **Require Payment Reference on Entry** check boxes. This will make it possible for users to skip entering values during the release of an invoice.
- 3. On the form toolbar, click**Save**.

## <span id="page-21-0"></span>**Preparing a Screen Configuration**
...
## <span id="page-21-1"></span>**Screen Configuration: General Information**
...
BqlString.Constant class. The name of the class starts with a lowercase letter. For an example, see *[Step 2:](#page-25-1) [Defining the Set of States of the Workflow](#page-25-1)* in the *Screen [Configuration:](#page-23-1) To Prepare a Screen Configuration for a Form Without a [Predefined](#page-23-1) Workflow* activity.
...
- *Conditions*: To define conditions in a screen configuration, you use the WithConditions method. For details, see *[Defining Conditions](#page-72-2)*.
- *Dialog boxes*: To define dialog boxes in a screen configuration, you use the WithForms method. For details, see *[Implementing Workflow Dialog Boxes](#page-74-2)*.
- *Fields*: To define the states of fields in a screen configuration, you use the WithFieldStates method. For details, see *[Configuring Field States](#page-82-2)*.
- *Actions and their categories*: To define actions and action categories, you use the WithActions and WithCategories methods. For details, see *[Implementing Workflow Actions](#page-40-2)*.
- *Workflow event handlers*: To define workflow event handlers, you use the WithHandlers method. For details, see *[Implementing Workflow Events](#page-85-2)*.
- *Any number of workflows*. For each workflow, you define the following:
  - The state-identifying field, which is the field that holds the state value for the workflow definition. You specify this field by calling the StateIdentifierIs method and providing the field name as a generic parameter. For an example, see *[Step 3: Overriding the Configure Method](#page-26-1)* in the *[Screen](#page-23-1) [Configuration:](#page-23-1) To Prepare a Screen Configuration for a Form Without a Predefined Workflow* activity.
...
- Workflow states, which can include action definitions and field states To define workflow states, you use the WithStates method. For details, see *[Defining Workflow States](#page-32-2)*.
- Workflow transitions, which can be triggered based on conditions

To define transitions, you use the WithTransitions method. For details, see *[Implementing](#page-63-2) Transitions*.
...
- 1. *Test Instance for Workflow [Customization:](#page-16-3) To Deploy a Test Instance*
- 2. *Test Instance for Workflow [Customization:](#page-18-2) To Turn On Workflow Validation*
...
## <span id="page-24-0"></span>**Step 1: Defining the Workflow Class**

In this step, you will define the RSSVWorkOrderEntry\_Workflow class that will contain a workflow for the Repair Work Orders (RS301000) form.

The business logic for the Repair Work Orders (RS301000) form is defined in the RSSVWorkOrderEntry graph, so you need to create the RSSVWorkOrderEntry\_Workflow class as an extension of the RSSVWorkOrderEntry graph.

To define the RSSVWorkOrderEntry\_Workflow workflow class, do the following:

- 1. In the PhoneRepairShop\_Code project, create the Workflows folder.
- 2. In the Workflows folder, add a new item named RSSVWorkOrderEntry\_Workflow.cs based on the C# class template.
- 3. In the RSSVWorkOrderEntry\_Workflow.cs file, define the workflow class, as the following code shows.
...
## <span id="page-25-1"></span><span id="page-25-0"></span>**Step 2: Defining the Set of States of the Workflow**
...
According to the customization description, which is available in *[Business Process Overview](#page-9-1)*, a repair work order can have the following statuses:
...
2. In the RSSVWorkOrderEntry\_Workflow class, define the Constants region and the public static class inside it, as the following code shows.
...
## <span id="page-26-1"></span><span id="page-26-0"></span>**Step 3: Overriding the Configure Method**
...
1. In the RSSVWorkOrderEntry\_Workflow class, declare the static Configure method as the following code shows.
...
## <span id="page-27-0"></span>**Screen Configuration: To Prepare a Screen Configuration with a Predefined Workflow**
...
Suppose that you need to define a workflow for the *[Invoices](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=0acc9738-f141-4ea0-a2be-f34ea9d1b63a)* (SO303000) form, which has a predefined workflow that is, a workflow that has been implemented by Acumatica developers.

#### **Process Overview**

To extend the predefined workflow of the *[Invoices](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=0acc9738-f141-4ea0-a2be-f34ea9d1b63a)* (SO303000) form, in the source code of Acumatica ERP, you will first find the class where the workflow is defined. You will then create an extension of this class and prepare the method where you can later customize the workflow.

#### **System Preparation**

As a prerequisite activity, perform the activities of the *[Preparing an Instance for Workflow Customization](#page-16-4)* chapter to configure your instance.

Make sure you have enabled the workflow validation as described in *Test Instance for Workflow [Customization:](#page-18-2) To Turn On Workflow [Validation](#page-18-2)*.
...
To locate the class where the workflow for the *[Invoices](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=0acc9738-f141-4ea0-a2be-f34ea9d1b63a)* (SO303000) form is defined, do the following:
...
- 1. In the Workflows folder of the PhoneRepairShop\_Code project, create the SOInvoiceRepairOrder\_Workflow.cs file.
- 2. In the SOInvoiceRepairOrder\_Workflow.cs file, define the SOInvoiceRepairOrder\_Workflow class, as the following code shows.

In the code above, you have defined an extension of the SOInvoiceEntry\_Workflow class. As a second parameter of the extension, you have specified the graph of the *[Invoices](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=0acc9738-f141-4ea0-a2be-f34ea9d1b63a)* form. In the extension, you have overridden the Configure(PXScreenConfiguration) method, which initializes the screen

configuration, and have declared the Configure(WorkflowContext) method, where you can later update the workflow.

- 3. Make sure that you have added the needed using directives.
- 4. Save your changes.

## <span id="page-29-1"></span><span id="page-29-0"></span>**Screen Configuration: Restrictions of the Configure Method**
...
For more information on database slots, see *[Use of Slots to Cache Data Objects](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=7d60ac9e-ff6c-40fc-a593-52e1545493fe)*.
...
//Replace the TGraph and TPrimaryEntity above with your actual graph and DAC classes,
```
...
public sealed override void Configure(PXScreenConfiguration config) =>
 ...
 //Replace the TGraph and TPrimaryEntity below with your actual graph and DAC classes,
 respectively
...
## <span id="page-32-3"></span><span id="page-32-1"></span>**Workflow States: General Information**
...
You can specify such properties as requirement, visibility, and availability. Settings specified in the WithFieldStates method override the values of parameters of the DAC field attributes. For details about specifying field properties for a workflow state, see *[Workflow States: Configuration of Field States](#page-34-1)*.

- Specify which actions are available in this workflow state and configure the appearance of these actions in this state, such as whether the action should be duplicated on the form toolbar. You do this by calling the WithActions method. For details on configuration of actions for a workflow state, see *[Workflow States:](#page-35-1) [Configuration of Actions](#page-35-1)*.
- Specify which workflow event handlers are available in this workflow state by calling the WithEventHandlers method. For details about workflow event handlers, see *[Workflow Events: General](#page-85-3) [Information](#page-85-3)*.
...
In the code above, the inclCustOpenOrders field is assigned *false* when the record enters the hold workflow state (aer the transition to this state is completed), and the inclCustOpenOrders field is assigned *true* before the hold workflow state is changed to some other state (before the transition is started).

## <span id="page-34-1"></span><span id="page-34-0"></span>**Workflow States: Configuration of Field States**

You can configure a state of a field in a screen configuration and in a workflow state.

The description of field states in a workflow state is applied aer the system applies the description of field states in the screen configuration and in the DAC so the configurations described in the workflow state can override other field state configuration. For example, if a field was visible under a condition in a screen configuration, it can be made invisible in a workflow state.

For details on configuring the state of a field in the screen configuration, see *[Configuring Field States](#page-82-2)*.
...
AddAllFieldsFromTables, and AddTables methods. For example, the following code adds the fields and tables from the previous code example by using only two method calls. If the fields and properties have the same configuration, such as being hidden, it can be assigned to all of them in a single method.
...
Only the value defined in the state of a field in a screen configuration can be restricted. For details on defining the list of combo box values in a screen configuration, see *[Field States: General Information](#page-82-3)*.
...
## <span id="page-35-1"></span><span id="page-35-0"></span>**Workflow States: Configuration of Actions**
...
This topic describes the configuration of actions in a workflow state. For details on configuring actions in a screen configuration, see *[Workflow Actions: Configuration of Actions](#page-42-1)*.
...
## <span id="page-37-1"></span><span id="page-37-0"></span>**Workflow States: To Define a Workflow State**
...
To define the workflow states, in the Configure method of the RSSVWorkOrderEntry\_Workflow class, you will call the WithFlowStates method in the lambda expression specified for the AddDefaultFlow method and provide the set of states in the parameter. You will define each state by calling the Add method and specifying the state-identifying string as a generic parameter. As a parameter of the Add method, you will specify a lambda expression where you will configure the workflow state.
...
- 1. Prepared an instance with the *PhoneRepairShop* customization project and enabled the workflow validation by performing the following prerequisite activities:
  - a. *Test Instance for Workflow [Customization:](#page-16-3) To Deploy a Test Instance*
  - b. *Test Instance for Workflow [Customization:](#page-18-2) To Turn On Workflow Validation*
- 2. Prepared the screen configuration and defined the set of states by performing the *Screen [Configuration:](#page-23-1) To Prepare a Screen [Configuration](#page-23-1) for a Form Without a Predefined Workflow* prerequisite activity.
...
- 1. In the RSSVWorkOrderEntry\_Workflow class, in the static Configure method, locate the AddDefaultFlow method. (You have added this method in *[Step 3: Overriding the Configure Method](#page-26-1)* of the *Screen [Configuration:](#page-23-1) To Prepare a Screen Configuration for a Form Without a Predefined Workflow* activity.)
...
1. Inside the lambda expression of the WithFlowStates method, aer the OnHold workflow state, define the ReadyForAssignment workflow state, as the following code shows.
...
## <span id="page-39-0"></span>**Workflow States: Tracking of Changes in States**
...
- A field of the Guid type that is declared with the *[PXDBStateChangedByID](https://help.acumatica.com/(W(6))/Help?ScreenId=ShowWiki&pageid=2e3b8495-2f7d-38f4-19de-fd648f80f2d5)* attribute. The field stores the ID of the user who made the last workflow transition for the data record.
...
• A field of the DateTime type that is declared with the *[PXDBStateChangedDateTime](https://help.acumatica.com/(W(4))/Help?ScreenId=ShowWiki&pageid=ef1bb3eb-6e2e-bc2e-c804-f05af16a0ec3)* attribute. The field stores the date and time in UTC of the data record's last workflow transition.
...
For each field, you also need to create the corresponding database column. For details, see *[Audit Fields](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=9dd06906-0b2f-498c-a333-cfd641bfbd9e)*.

## <span id="page-40-2"></span><span id="page-40-0"></span>**Implementing Workflow Actions**
...
## <span id="page-40-1"></span>**Workflow Actions: General Information**
...
For more information about actions, see *[Action Definition: General Information](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=f0092274-206c-4059-bbf4-ad37e93a336a)* and the *T230 Actions* training course.
...
## <span id="page-42-1"></span><span id="page-42-0"></span>**Workflow Actions: Configuration of Actions**

You can configure workflow actions in the following ways:

- Add, update, or delete an action in the screen configuration by calling the Add, Update, or Delete method, respectively, in the WithActions method at the screen configuration level. For example, see *[Step 3: Adding the Action to the Workflow](#page-52-2)* of the *Workflow Actions: To [Implement](#page-50-1) a Simple [Action](#page-50-1)* activity.
...
For details on configuring an action in a workflow state, see *[Workflow States: Configuration of Actions](#page-35-1)*.

For example, see *Workflow States: To Define a [Workflow](#page-37-1) State*.

- Assign field values when the action is performed by calling the WithFieldAssignments method while adding or updating the action in the screen configuration. For a detailed example, see *[Workflow](#page-53-1) Actions: To [Implement an Action with Field Assignments](#page-53-1)*.
- Provide the parameters of an action by calling the WithParameterAssignments method.
- Display a dialog box when an action is clicked by calling the WithForm method. For details on defining dialog boxes, see *[Workflow Dialog Boxes: General Information](#page-74-3)*.
- Configure the appearance of an action on the More menu and form toolbar. For more information, see *[Workflow Actions: Appearance of Buttons and Commands](#page-43-1)*.
- Configure the persisting options. That is, you can specify when the system should save the current changes to the database. For details about persisting options, see *[Workflow Actions: Persisting Options](#page-44-1)*.
- Configure mass processing, as described in *[Workflow Actions: Mass Processing Actions](#page-45-1)*.
- Configure the behavior of an action. For details, see *[Workflow Actions: Action's Behavior](#page-46-1)*.
- Map an action to the Acumatica mobile app.
- Display an action on a side panel by calling the IsSidePanelScreenmethod, as described in *[Workflow](#page-47-1) [Actions: Opening of a Side Panel](#page-47-1)*
...
| Configuration Type                                             | Graph | Screen Configura<br>tion | Workflow State | Comment                                                                                          |  |  |
|----------------------------------------------------------------|-------|--------------------------|----------------|--------------------------------------------------------------------------------------------------|--|--|
| Visibility                                                     | +     | +                        |                | The condition on<br>the next level can                                                           |  |  |
| Availability                                                   | +     | +                        |                | only narrow what<br>has been defined in<br>the previous level.                                   |  |  |
| Category                                                       | +     | +                        |                | The location inside<br>the category can be<br>specified only in the<br>screen configura<br>tion. |  |  |
| Connotation                                                    | +     |                          | +              |                                                                                                  |  |  |
| Display on the form<br>toolbar                                 | +     |                          | +              |                                                                                                  |  |  |
| Assign field values                                            | +     | +                        |                |                                                                                                  |  |  |
| Provide parameters                                             |       | +                        |                |                                                                                                  |  |  |
| Display a workflow<br>dialog box                               |       | +                        |                |                                                                                                  |  |  |
| Configure the per<br>sisting option                            | +     | +                        |                |                                                                                                  |  |  |
| Run report, open a<br>generic inquiry, cre<br>ate a new record | +     | +                        |                |                                                                                                  |  |  |
| Expose the action to<br>the mobile app                         |       | +                        |                |                                                                                                  |  |  |
...
For this method to work, you must use MSDL to map the screen where the action should be displayed. For more information about mapping forms to the Acumatica mobile app, see *[Mobile Framework Guide](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=5dacbf34-ac82-41b4-b498-839c173f587c)*.

## <span id="page-43-1"></span><span id="page-43-0"></span>**Workflow Actions: Appearance of Buttons and Commands**
...
To adjust the appearance of a button or command in a specific state of a workflow, you configure the workflow state as described in *[Workflow States: Configuration of Actions](#page-35-1)*.

## <span id="page-44-1"></span><span id="page-44-0"></span>**Workflow Actions: Persisting Options**

In the code of a graph, you can save the changes to the database by calling the *[PXGraph.Persist](https://help.acumatica.com/(W(3))/Help?ScreenId=ShowWiki&pageid=198bc715-56b2-37c5-895f-fd136023c404)* method. When adding an action to a screen configuration, you can configure whether and when the current changes in the cache should be saved to the database—that is, when the system should invoke the Persist method.

This configuration can be defined in the WithPersistOptions method by using the values of the *[ActionPersistOptions](https://help.acumatica.com/(W(3))/Help?ScreenId=ShowWiki&pageid=ac196732-c068-f047-93e2-add0e7bc0de2)* enumerator.
...
The following example shows an action from the workflow on the *[Opportunities](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=5cb49cd5-2be8-4617-9341-958f1c5d6d53)* (CR304000) form.
...
For a detailed example, see *Processing Forms: Activity 1.1.1: To Create a Simple [Processing](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=f0c1a34a-7021-4916-9495-247e07efee9d) Form*.

## <span id="page-46-1"></span><span id="page-46-0"></span>**Workflow Actions: Action's Behavior**
...
- 1. You get the screen configuration and configure the side panel settings as follows:
  - a. You get the screen configuration by using the GetScreenConfigurationContext method, and you add a set of settings (for the new action to be defined in the next step) to the screen configuration by using the SidePanel method. This method is provided by the Navigation helper object of the screen configuration. See the following code for an example.
...
b. In the lambda expression of the SidePanel method in the code above, you call the NavigateToScreen method and pass in a ScreenID as a parameter. This ScreenID should belong to the form that you want to open when the action is triggered on the UI. You can pass in the ScreenID as a string or as a graph type such as NavigateToScreen<SOOrderEntry>().
...
```
 ...
 {
 filler.Add(nameof(SOOrder.OrderNbr), c =>
 c.SetFromField<orderNbr>());
 }));
```
...
- 2. Add a new action to the screen configuration and configure it to open a side panel as follows:
  ...
  - b. You call the IsSidePanelScreen method and pass as a parameter the sidePanel variable that you created in Step 1a. The sidePanel variable defines the side panel configuration of the new action. An example is shown in the following code.

```
 var action = 
 context.ActionDefinitions.CreateNew("ShowInvoicesAndMemos", a =>
...
## <span id="page-49-0"></span>**Workflow Actions: Categories of the More Menu**
...
- 1. You define and configure the category, as described in *[Creating a Category](#page-49-1)*
...
#### <span id="page-49-1"></span>**Creating a Category**
...
You can specify the location of a category on the More menu by calling the Place method. A category can be placed first, last, or before or aer a specified category by using the Placement parameter of this method.
...
## <span id="page-50-1"></span><span id="page-50-0"></span>**Workflow Actions: To Implement a Simple Action**
...
## <span id="page-51-1"></span><span id="page-51-0"></span>**Step 1: Implementing the Action in the Graph**
...
## <span id="page-52-0"></span>**Step 2: Defining a Category for the Action**
...
1. In the static Configure method of the RSSVWorkOrderEntry\_Workflow class, define the **Processing** category before the context.AddScreenConfigurationFor method call, as the following code shows.
...
- 2. In the static Configure method, locate the AddDefaultFlow method, which you have added in *[Step](#page-26-1) [3: Overriding the Configure Method](#page-26-1)* in the *Screen [Configuration:](#page-23-1) To Prepare a Screen Configuration for a Form Without a [Predefined](#page-23-1) Workflow*.
- 3. For the screen parameter, call the WithCategories method aer the AddDefaultFlow method as the following code shows.
...
## <span id="page-52-2"></span><span id="page-52-1"></span>**Step 3: Adding the Action to the Workflow**
...
- 1. In the RSSVWorkOrderEntry\_Workflow class, in the static Configure method, locate the AddDefaultFlow method. (You have added this method in *[Step 3: Overriding the Configure Method](#page-26-1)* in the *Screen [Configuration:](#page-23-1) To Prepare a Screen Configuration for a Form Without a Predefined Workflow* activity.)
- 2. For the screen parameter, call the WithActions method aer the WithCategories method, as the following code shows.
...
- 1. Prepared an instance with the *PhoneRepairShop* customization project and enabled the workflow validation by performing the following prerequisite activities:
  ...
  - b. *Test Instance for Workflow [Customization:](#page-18-2) To Turn On Workflow Validation*
- 2. Prepared the screen configuration and defined the set of states by performing the *Screen [Configuration:](#page-23-1) To Prepare a Screen [Configuration](#page-23-1) for a Form Without a Predefined Workflow* prerequisite activity.
- 3. Defined the Assigned workflow state by performing the *Workflow Dialog Boxes: To [Implement](#page-78-2) a Transition [with a Dialog Box](#page-78-2)* prerequisite activity.

## <span id="page-54-0"></span>**Step 1: Adding and Configuring the Action**
...
2. In the RSSVWorkOrderEntry\_Workflow class, add the Complete action in the lambda expression for the WithActions method, as the following code shows.
...
## <span id="page-54-1"></span>**Step 2: Adding a Workflow State and a Transition**
...
2. In the RSSVWorkOrderEntry\_Workflow class, add the GetCompletedBehavior private static method, as the following code shows.
...
## <span id="page-55-0"></span>**Step 3: Testing the Field Assignment**
...
- 1. Rebuild the PhoneRepairShop\_Code project.
- 2. In Acumatica ERP, open a repair work order with the *Assigned* status on the Repair Work Orders (RS301000) form.
- 3. On the form toolbar, click **Complete**. Notice that the document's status has been changed to *Completed* and the **Date Completed** box has the current business date.

## <span id="page-55-2"></span><span id="page-55-1"></span>**Workflow Actions: To Configure the Conditional Appearance of the Action**
...
- 1. Prepared an instance with the *PhoneRepairShop* customization project and enabled the workflow validation by performing the following prerequisite activities:
  - a. *Test Instance for Workflow [Customization:](#page-16-3) To Deploy a Test Instance*
  - b. *Test Instance for Workflow [Customization:](#page-18-2) To Turn On Workflow Validation*
  - c. *Test Instance for Workflow [Customization:](#page-18-3) To Configure the Instance*
- 2. Prepared the screen configuration and defined the set of states by performing the *Screen [Configuration:](#page-23-1) To Prepare a Screen [Configuration](#page-23-1) for a Form Without a Predefined Workflow* prerequisite activity.
- 3. Defined the PendingPayment and Completed workflow states by performing the *[Transitions:](#page-64-1) To [Implement](#page-64-1) a Transition Triggered by an Action* and *Workflow Actions: To [Implement](#page-53-1) an Action with Field [Assignments](#page-53-1)* prerequisite activities.

## <span id="page-56-0"></span>**Step 1: Defining the Graph Action**
...
Instead of adding the using directives manually, you can add them with the help of the Quick Actions and Refactorings feature of Visual Studio aer you define the method in the next instruction.
...
You have initialized the summary of the invoice by using the ARInvoice class. You have assigned a value to the CustomerID field, which is required to create an invoice. Aer that you have updated the ARInvoice instance in cache.

- b. You have created an instance of the RSSVWorkOrderEntry graph, which you need to get access to the current work order and to save the generated invoice number to the current work order.
- c. You have selected the repair and labor items specified on the Repair Work Orders form by using the instance of the RSSVWorkOrderEntry graph. Then you have added lines to the invoice by adding instances of the ARTran class: the lines associated with repair items, followed by the lines associated with labor items.
- d. To save the created invoice in the database, you have called the PressSave() method of the SOInvoiceEntry graph.
- e. You have saved the number of the generated invoice to the work order and updated its value in the cache. Then you have saved the changes to the database by invoking the Actions.PressSave() method.
- f. At the end of the method, you have completed the transaction.
...
## <span id="page-59-0"></span>**Step 2: Configuring the Conditional Appearance of the Button**
...
- b. Make sure an instance of the Conditions class is created in the static Configure method.
- c. In the WithActions method of the screen configuration, register the CreateInvoice action, as the following code shows.
...
## <span id="page-60-0"></span>**Step 3: Testing the Action**
...
| <b>Repair Work Orders</b><br>000003 - Battery Replacement<br>툳<br>$\Xi$<br>↶<br>$\leftarrow$              |                                                           | 侕                                        | O.<br>$\checkmark$ | $\overline{\mathbf{K}}$                                          | $\sim$ $\sim$ | $\rightarrow$ | $\geq$                                     |  | <b>CREATE INVOICE</b>           |                                                                               | .     | $\Box$ NOT                           |  | Executing. Press to abort<br>00:00:02 |              | <b>CANCEL</b>           |     |
|-----------------------------------------------------------------------------------------------------------|-----------------------------------------------------------|------------------------------------------|--------------------|------------------------------------------------------------------|---------------|---------------|--------------------------------------------|--|---------------------------------|-------------------------------------------------------------------------------|-------|--------------------------------------|--|---------------------------------------|--------------|-------------------------|-----|
| Order Nbr.:<br>Status:<br>* Date Created:<br>Date Completed: 4/9/2025<br>Priority:<br><b>REPAIR ITEMS</b> | 000003<br>Completed<br>4/9/2025<br>Medium<br><b>LABOR</b> | $\varphi$<br>Ö<br>v                      |                    | Customer ID:<br>Service:<br>Device:<br>Assignee:<br>Description: |               |               | NOKIA3310 - Nokia 3310<br>Andrews, Michael |  | Battery replacement, Nokia 3310 | C000000001 - Jersey Central Office Equi<br>BATTERYREPLACE - Battery Replaceme | α     | <b>Order Total:</b><br>Invoice Nbr.: |  | 35.00                                 |              |                         | ㅅ   |
| Ò<br>$\mathrm{+}$<br>0                                                                                    | н<br>×                                                    | $\boxed{\mathbf{N}}$                     |                    |                                                                  |               |               |                                            |  |                                 |                                                                               |       |                                      |  |                                       |              |                         |     |
| $\Box$ Repair Item Type<br>0<br>в                                                                         |                                                           | <b>Inventory ID</b>                      |                    | <b>Description</b>                                               |               |               |                                            |  |                                 |                                                                               | Price |                                      |  |                                       |              |                         |     |
| ם<br>0<br><b>Battery</b><br>≻                                                                             |                                                           | <b>BAT3310</b>                           |                    | Battery for Nokia 3310                                           |               |               |                                            |  |                                 |                                                                               | 20.00 |                                      |  |                                       |              |                         |     |
| 0<br>ם<br><b>Back Cover</b>                                                                               |                                                           | !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! |                    | Back cover for Nokia 3310                                        |               |               |                                            |  |                                 |                                                                               | 10.00 |                                      |  |                                       |              |                         |     |
|                                                                                                           |                                                           |                                          |                    |                                                                  |               |               |                                            |  |                                 |                                                                               |       |                                      |  |                                       | $\mathbf{K}$ | $\langle \quad \rangle$ | $>$ |
...
| <b>Repair Work Orders</b><br>M <sub>NOT</sub><br>000003 - Battery Replacement                             |                                                           |                                          |                    |                                                                  |               |               |                                                                               | The operation has<br>completed. |  |                                                                               |           | $\times$                      |                           |              |           |               |        |
|-----------------------------------------------------------------------------------------------------------|-----------------------------------------------------------|------------------------------------------|--------------------|------------------------------------------------------------------|---------------|---------------|-------------------------------------------------------------------------------|---------------------------------|--|-------------------------------------------------------------------------------|-----------|-------------------------------|---------------------------|--------------|-----------|---------------|--------|
| 뭐<br>R<br>$\leftarrow$                                                                                    | ↶<br>┿                                                    | ⋒                                        | n.<br>$\checkmark$ | $\overline{\mathsf{K}}$                                          | $\sim$ $\sim$ | $\rightarrow$ | $\lambda$                                                                     | $\cdots$                        |  |                                                                               |           |                               |                           |              |           |               |        |
| Order Nbr.:<br>Status:<br>* Date Created:<br>Date Completed: 4/9/2025<br>Priority:<br><b>REPAIR ITEMS</b> | 000003<br>Completed<br>4/9/2025<br>Medium<br><b>LABOR</b> | $\varphi$<br>户<br>$\checkmark$           |                    | Customer ID:<br>Service:<br>Device:<br>Assignee:<br>Description: |               |               | NOKIA3310 - Nokia 3310<br>Andrews, Michael<br>Battery replacement, Nokia 3310 |                                 |  | C000000001 - Jersey Central Office Equi<br>BATTERYREPLACE - Battery Replaceme | $\varphi$ | Order Total:<br>Invoice Nbr.: | 35.00<br><b>INV000049</b> |              |           |               | $\sim$ |
| $\pm$<br>0<br>O                                                                                           | $\vdash$<br>$\times$                                      | $\mathbf{\overline{x}}$                  |                    |                                                                  |               |               |                                                                               |                                 |  |                                                                               |           |                               |                           |              |           |               |        |
| ם<br>Repair Item Type<br>8.                                                                               |                                                           | <b>Inventory ID</b>                      |                    | <b>Description</b>                                               |               |               |                                                                               |                                 |  |                                                                               | Price     |                               |                           |              |           |               |        |
| 0<br>$\Box$<br>Battery                                                                                    |                                                           | <b>BAT3310</b>                           |                    | Battery for Nokia 3310                                           |               |               |                                                                               |                                 |  |                                                                               | 20.00     |                               |                           |              |           |               |        |
| 0<br>D<br><b>Back Cover</b>                                                                               |                                                           | !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! |                    | Back cover for Nokia 3310                                        |               |               |                                                                               |                                 |  |                                                                               | 10.00     |                               |                           |              |           |               |        |
|                                                                                                           |                                                           |                                          |                    |                                                                  |               |               |                                                                               |                                 |  |                                                                               |           |                               |                           | $\mathbf{K}$ | $\,$ $\,$ | $\rightarrow$ | $>$    |

*Figure: The invoice number of the repair work order*

## <span id="page-61-0"></span>**Workflow Actions: Order of Field Assignments**

The order in which field assignments are declared in code is important because the system processes the field assignments in that order. You can define the order in which a field assignment is processed by specifying whether a field assignment should be placed before or aer another field assignment. You do this by calling the PlaceBefore or PlaceAfter method.
...
## <span id="page-63-2"></span><span id="page-63-0"></span>**Implementing Transitions**
...
## <span id="page-63-1"></span>**Transitions: General Information**
...
- Specify the condition on which a transition is performed by calling the When method. For an example of this implementation, see *[Transitions:](#page-67-2) To Implement a Group of Transitions*.

- Define the order in which the system checks a transition by specifying whether the transition should be placed before or aer another transition. You do this by calling the PlaceBefore or PlaceAfter method. By default, transitions are executed based on their order of declaration in code.
...
## <span id="page-64-1"></span><span id="page-64-0"></span>**Transitions: To Implement a Transition Triggered by an Action**
...
- The ReadyForAssignment workflow state, which is the target workflow state for the transition. You have defined both workflow states in *Workflow States: To Define a [Workflow](#page-37-1) State*.
- The ReleaseFromHold action, which is the element that triggers the transition. In this activity, you will use the implementation of the ReleaseFromHold action from *[Workflow Actions:](#page-50-1) To [Implement](#page-50-1) a Simple Action*.
- The transition.
...
- 1. Prepared an instance with the *PhoneRepairShop* customization project and enabled the workflow validation by performing the following prerequisite activities:
  ...
  - b. *Test Instance for Workflow [Customization:](#page-18-2) To Turn On Workflow Validation*
- 2. Prepared the screen configuration and defined the set of states by performing the *Screen [Configuration:](#page-23-1) To Prepare a Screen [Configuration](#page-23-1) for a Form Without a Predefined Workflow* prerequisite activity.
- 3. Defined the ReleaseFromHold action by performing the *Workflow Actions: To [Implement](#page-50-1) a Simple Action* activity.
- 4. Defined the OnHold and ReadyForAssignment states by performing the *[Workflow](#page-37-1) States: To Define a [Workflow State](#page-37-1)* activity.
...
- 1. In the RSSVWorkOrderEntry\_Workflow class, in the static Configure method, locate the AddDefaultFlow method.
...
| <b>Repair Work Orders</b><br><b>Battery Replacement</b>                    |                                                                                                                |       | notes               | <b>FILES</b> | <b>CUSTOMIZATION</b>  | TOOLS $\blacktriangledown$ |
|----------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------|-------|---------------------|--------------|-----------------------|----------------------------|
| 周<br>周<br>侕<br>$\pm$<br>↶<br>$\leftarrow$                                  | <b>REMOVE HOLD</b><br>$\bigcirc$ $\sim$<br>$\overline{\mathbf{R}}$<br>$\sim$ $\sim$<br>$\rightarrow$<br>$\geq$ |       |                     |              |                       |                            |
| Order Nbr.:<br>$<\!\!N\!\!E W\!\!>$                                        | ρ<br>* Customer ID:<br>C000000001 - Jersey Central Office E P                                                  |       | <b>Order Total:</b> | 35.00        |                       | $\hat{\phantom{a}}$        |
| Status:<br>On Hold                                                         | * Service:<br>BATTERYREPLACE - Battery Replace Q                                                               |       | Invoice Nbr.:       |              |                       |                            |
| Ö<br>4/9/2025<br>* Date Created:                                           | NOKIA3310 - Nokia 3310<br>* Device:                                                                            | Q     |                     |              |                       |                            |
| Date Completed:                                                            | Assignee:                                                                                                      | Q     |                     |              |                       |                            |
| Priority:<br>Medium                                                        | Description:<br>Battery replacement, Nokia 3310<br>$\checkmark$                                                |       |                     |              |                       |                            |
| <b>REPAIR ITEMS</b><br><b>LABOR</b>                                        |                                                                                                                |       |                     |              |                       |                            |
| Ò<br>$\mathbf{\overline{X}}$<br>$\mathbb{H}$<br>$\ddot{}$<br>$\times$<br>0 |                                                                                                                |       |                     |              |                       |                            |
| $\Box$ Repair Item Type<br><b>B</b> 0<br><b>Inventory ID</b>               | <b>Description</b>                                                                                             | Price |                     |              |                       |                            |
| D<br>0<br>Battery<br><b>BAT3310</b>                                        | Battery for Nokia 3310                                                                                         | 20.00 |                     |              |                       |                            |
| 0<br>D<br><b>Back Cover</b><br>!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!    | Back cover for Nokia 3310                                                                                      | 10.00 |                     |              |                       |                            |
|                                                                            |                                                                                                                |       |                     |              |                       |                            |
|                                                                            |                                                                                                                |       |                     |              |                       |                            |
|                                                                            |                                                                                                                |       |                     |              |                       |                            |
|                                                                            |                                                                                                                |       |                     |              |                       |                            |
|                                                                            |                                                                                                                |       |                     |              |                       |                            |
|                                                                            |                                                                                                                |       |                     |              | $\mathbf{K}$<br>$\,<$ | $\rightarrow$<br>$>$       |
|                                                                            |                                                                                                                |       |                     |              |                       |                            |
...
| <b>Repair Work Orders</b><br><b>TH</b> NOTES<br><b>FILES</b><br>000003 - Battery Replacement                                 | <b>CUSTOMIZATION</b><br>TOOLS $\blacktriangledown$ |
|------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------|
| 0 ∼<br>품<br>$\Xi$<br>何<br>$\overline{\mathsf{K}}$<br>$\langle \rangle$ > > $\rangle$<br>$+$<br>↶<br>$\overline{\phantom{0}}$ |                                                    |
| ρ<br>Customer ID:<br>Order Nbr.:<br><b>Order Total:</b><br>C000000001 - Jersey Central Office Equi<br>000003<br>35.00        | $\sim$                                             |
| Service:<br>Invoice Nbr.:<br>Status:<br>Ready for Assignment<br><b>BATTERYREPLACE - Battery Replaceme</b>                    |                                                    |
| 4/9/2025<br>Ä<br>NOKIA3310 - Nokia 3310<br>* Date Created:<br>Device:                                                        |                                                    |
| Q<br>Assignee:<br>Date Completed:                                                                                            |                                                    |
| Medium<br>Priority:<br>Description:<br>Battery replacement, Nokia 3310<br>$\checkmark$                                       |                                                    |
|                                                                                                                              |                                                    |
| <b>REPAIR ITEMS</b><br>LABOR                                                                                                 |                                                    |
| $\mathbf{H}$<br>$\mathbf{x}$<br>Ò<br>$\ddot{}$<br>$\times$<br>0                                                              |                                                    |
| D<br>B 0<br><b>Repair Item Type</b><br><b>Inventory ID</b><br><b>Description</b><br>Price                                    |                                                    |
| D<br>0<br><b>Battery</b><br><b>BAT3310</b><br>Battery for Nokia 3310<br>20.00                                                |                                                    |
| 0<br><b>Back Cover</b><br>D<br><b>BCOV3310</b><br>Back cover for Nokia 3310<br>10.00                                         |                                                    |
|                                                                                                                              |                                                    |
|                                                                                                                              |                                                    |
|                                                                                                                              |                                                    |
|                                                                                                                              |                                                    |
|                                                                                                                              |                                                    |
| $\mathbf{K}$                                                                                                                 | $\langle \quad \rangle$<br>>1                      |

*Figure: A record with the Ready for Assignment status*

## <span id="page-67-0"></span>**Transitions: Transition Groups**
...
## <span id="page-67-2"></span><span id="page-67-1"></span>**Transitions: To Implement a Group of Transitions**
...
In *[Transitions:](#page-64-1) To Implement a Transition Triggered by an Action*, you have implemented an unconditional transition from the OnHold workflow state to the ReadyForAssignment workflow state.
...
- 1. Prepared an instance with the *PhoneRepairShop* customization project and enabled the workflow validation by performing the following prerequisite activities:
  - a. *Test Instance for Workflow [Customization:](#page-16-3) To Deploy a Test Instance*
  - b. *Test Instance for Workflow [Customization:](#page-18-2) To Turn On Workflow Validation*
- 2. Prepared the screen configuration and define the set of states by performing the *Screen [Configuration:](#page-23-1) To Prepare a Screen [Configuration](#page-23-1) for a Form Without a Predefined Workflow* prerequisite activity.
- 3. Defined the OnHold and ReadyForAssignment workflow states by performing the *[Workflow](#page-37-1) States: To [Define a Workflow State](#page-37-1)* prerequisite activity.
- 4. Implemented a transition from the OnHold workflow state to the ReadyForAssignment workflow state by performing the *[Transitions:](#page-64-1) To Implement a Transition Triggered by an Action* activity.

## <span id="page-68-1"></span><span id="page-68-0"></span>**Step 1: Adding a Condition**
...
- 1. In the RSSVWorkOrderEntry\_Workflow class, add the Conditions region.
...
## <span id="page-69-3"></span><span id="page-69-0"></span>**Step 2: Adding the PendingPayment Workflow State (Self-Guided Exercise)**

To define a transition from the OnHold workflow state to the PendingPayment workflow state, you first need to define the PendingPayment workflow state. In this step, you will define the PendingPayment state of the workflow as a self-guided exercise. You have learned how to add a workflow state in *[Workflow](#page-37-1) States: To Define a [Workflow State](#page-37-1)*.

While defining a state, you need to use the States.pendingPayment class, which you have added in *[Step 2:](#page-25-1) [Defining the Set of States of the Workflow](#page-25-1)* of the *Screen [Configuration:](#page-23-1) To Prepare a Screen Configuration for a Form Without a [Predefined](#page-23-1) Workflow* activity. In the PendingPayment workflow state, make the **Customer ID**, **Service ID**, and **Device ID** boxes of the Repair Work Orders (RS301000) form are unavailable for this workflow state.

## <span id="page-69-2"></span><span id="page-69-1"></span>**Step 3: Grouping Transitions and Adding Conditions to Transitions**

In this step, you will group transitions and add a condition to each transition.

To specify the conditions you defined in *[Step 1: Adding a Condition](#page-68-1)* of this activity, do the following:
...
2. Move the definition of the transition that you added in *[Transitions:](#page-64-1) To Implement a Transition Triggered by [an Action](#page-64-1)* inside the group, and remove the call of the From method because it is no longer necessary. The resulting code is shown below.
...
3. Aer the IsTriggeredOn method call, add the When method call, and specify the RequiresPrepayment condition with the logical NOT operator, as the following code shows.
...
4. Aer this transition, add the new transition from the OnHold state to the PendingPayment state, as the following code shows. Specify the RequiresPrepayment condition.
...
## <span id="page-70-0"></span>**Step 4 (Optional): Specifying the Order of Transitions**

Transitions are checked based on their order of declaration in code. To specify that a transition should be checked before or aer another transition, you should call the PlaceBefore or PlaceAfter method,

In *Step 3: Grouping [Transitions](#page-69-2) and Adding Conditions to Transitions*, you have defined the following transitions from the onHold workflow state:

- A transition to the readyForAssignment workflow state
- A transition to the pendingPayment workflow state

Suppose that you want to make sure that the transition to the pendingPaymentworkflow state is always checked before the transition to the readyForAssignment workflow state.
...
In this code,you have called the PlaceBefore method aer calling the When method. Notice that you have passed in a lambda expression as a parameter to the PlaceBefore method, and within it, you have specified transition.To<States.readyForAssignment>() as the transition before which you want the transition being defined to be checked.

## <span id="page-71-0"></span>**Step 5: Testing Transitions With Conditions**
...
- 5. Notice that the repair work order status has been changed to *Pending Payment* (in contrast to what has been tested in *[Transitions:](#page-64-1) To Implement a Transition Triggered by an Action*), because the service specified for the order requires prepayment. You can see that the service requires prepayment on the Repair Services (RS201000) form.

## <span id="page-72-2"></span><span id="page-72-0"></span>**Defining Conditions**
...
## <span id="page-72-1"></span>**Conditions: General Information**
...
You should call the IsDisabledWhen method while adding an action to a screen configuration and provide a condition as a parameter. For an example, see *Workflow Actions: To Configure the [Conditional](#page-55-2) [Appearance of the Action](#page-55-2)*.

- To hide a field, make the field unavailable, or make the field required depending on a condition. You do this while configuring the state of the field in the screen configuration. For details, see *[Field States:](#page-82-3) [General Information](#page-82-3)*.
- To hide a dialog box field depending on a condition.

You call the IsHiddenWhen method while adding this field to a dialog box and provide a condition as a parameter. For details, see *[Workflow Dialog Boxes: Configuration of Fields](#page-75-1)*.
...
For the full example, see *[Transitions:](#page-67-2) To Implement a Group of Transitions*.

## <span id="page-74-2"></span><span id="page-74-0"></span>**Implementing Workflow Dialog Boxes**
...
## <span id="page-74-3"></span><span id="page-74-1"></span>**Workflow Dialog Boxes: General Information**
...
- 2. You configure fields and layout of the workflow dialog box as described in *[Workflow Dialog Boxes:](#page-75-1) [Configuration of Fields](#page-75-1)* and *[Workflow Dialog Boxes: Configuration of the Layout](#page-77-1)*.
...
The original code of the action is executed only aer the workflow dialog box is closed and field assignments are applied. If an action triggers a transition, the transition is performed only if a user clicks **OK** in the dialog box.

## <span id="page-75-1"></span><span id="page-75-0"></span>**Workflow Dialog Boxes: Configuration of Fields**
...
## <span id="page-77-1"></span><span id="page-77-0"></span>**Workflow Dialog Boxes: Configuration of the Layout**
...
## <span id="page-78-2"></span><span id="page-78-0"></span>**Workflow Dialog Boxes: To Implement a Transition with a Dialog Box**
...
- 1. Prepared an instance with the *PhoneRepairShop* customization project and enabled the workflow validation by performing the following activities:
  - a. *Test Instance for Workflow [Customization:](#page-16-3) To Deploy a Test Instance*
  - b. *Test Instance for Workflow [Customization:](#page-18-2) To Turn On Workflow Validation*
- 2. Prepared the screen configuration and defined the set of states by performing the *Screen [Configuration:](#page-23-1) To Prepare a Screen [Configuration](#page-23-1) for a Form Without a Predefined Workflow* activity.
- 3. Implemented the ReadyForAssignmentworkflow state by performing the *[Workflow](#page-37-1) States: To Define a [Workflow State](#page-37-1)* activity.

## <span id="page-78-1"></span>**Step 1: Defining a Workflow Dialog Box**

In this step, you will define and configure the **Assign** dialog box.

Do the following:

1. In the static Configure method of the RSSVWorkOrderEntry\_Workflow class, define the **Assign** workflow dialog box, as the following code shows.
...
## <span id="page-79-0"></span>**Step 2: Defining the Action That Opens the Workflow Dialog Box**
...
2. In the RSSVWorkOrderEntry\_Workflow class, in the lambda expression for the WithActions method at the screen configuration level, add the Assign action, as the following code shows.
...
## <span id="page-80-2"></span><span id="page-80-0"></span>**Step 3: Defining the Workflow State and the Transition (Self-Guided Exercise)**

In this step, you will define the Assigned workflow state and the transition from the ReadyForAssignment workflow state to the Assigned workflow state on your own. You have learned how to define a workflow state in *Workflow States: To Define a [Workflow](#page-37-1) State*.

While defining a workflow state, you need to use the States.assigned class, which you added in *[Workflow](#page-37-1) States: To Define a [Workflow](#page-37-1) State*. In the Assigned workflow state, you should make the **Customer ID**, **Service ID**, and **Device ID** boxes unavailable for the state. Also, you need to add the Assign action to the ReadyForAssignment workflow state, display it on the form toolbar, and specify the *Success* connotation for it.

For details on defining transitions, see *[Transitions:](#page-64-1) To Implement a Transition Triggered by an Action* and *[Transitions:](#page-67-2) To Implement a Group of [Transitions](#page-67-2)*. The transition should be defined inside a group and is performed without any conditions.

## <span id="page-80-1"></span>**Step 4: Testing the Assign Action**
...
| <b>Repair Work Orders</b><br>000003 - Battery Replacement                |                                                                              |                           | $\Box$ NOTES  | <b>FILES</b> | <b>CUSTOMIZATION</b> | TOOLS $\blacktriangledown$        |
|--------------------------------------------------------------------------|------------------------------------------------------------------------------|---------------------------|---------------|--------------|----------------------|-----------------------------------|
| $\cap$ $\sim$<br>뭐<br>$\Box$<br>何<br>↶<br>$\leftarrow$                   | <b>HOLD</b><br>$\overline{\mathsf{K}}$<br>$\prec$<br>$\rightarrow$<br>$\geq$ | <b>ASSIGN</b><br>$\cdots$ |               |              |                      |                                   |
| Q<br>Order Nbr.:<br>000003                                               | Customer ID:<br>C000000001 - Jersey Central Office Equi                      |                           | Order Total:  | 35.00        |                      | $\hat{\phantom{a}}$               |
| Status:<br>Ready for Assignment                                          | Service:<br>BATTERYREPLACE - Battery Replaceme                               |                           | Invoice Nbr.: |              |                      |                                   |
| 4/9/2025<br>Ö<br>* Date Created:                                         | NOKIA3310 - Nokia 3310<br>Device:                                            |                           |               |              |                      |                                   |
| Date Completed:                                                          | Assignee:                                                                    | Q                         |               |              |                      |                                   |
| Priority:<br>Medium<br>$\sim$                                            | Description:<br>Battery replacement, Nokia 3310                              |                           |               |              |                      |                                   |
| <b>REPAIR ITEMS</b><br><b>LABOR</b>                                      |                                                                              |                           |               |              |                      |                                   |
| $\mathbf{\overline{X}}$<br>$\times$<br>$\mathbb H$<br>Ò<br>$\mathscr{Q}$ |                                                                              |                           |               |              |                      |                                   |
| D<br><b>Repair Item Type</b><br><b>Inventory ID</b><br>8.                | <b>Description</b>                                                           | Price                     |               |              |                      |                                   |
| ם<br>$\mathbf{0}$<br>Battery<br><b>BAT3310</b>                           | Battery for Nokia 3310                                                       | 20.00                     |               |              |                      |                                   |
| 0<br>ם<br><b>Back Cover</b><br><b>BCOV3310</b>                           | Back cover for Nokia 3310                                                    | 10.00                     |               |              |                      |                                   |
|                                                                          |                                                                              |                           |               |              |                      |                                   |
|                                                                          |                                                                              |                           |               |              |                      |                                   |
|                                                                          |                                                                              |                           |               |              |                      |                                   |
|                                                                          |                                                                              |                           |               |              |                      |                                   |
|                                                                          |                                                                              |                           |               |              |                      |                                   |
|                                                                          |                                                                              |                           |               |              | $\mathbf{K}$         | $\langle \quad \rangle$ $\rangle$ |
...
| <b>Repair Work Orders</b><br>000003 - Battery Replacement                            |                                                                                                         | n NOTES<br><b>FILES</b><br><b>CUSTOMIZATION</b><br>TOOLS $\blacktriangledown$ |
|--------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|
| 周<br>$\circ$ $\circ$<br>$\Box$<br>⑩<br>$\curvearrowleft$<br>$\leftarrow$             | <b>ASSIGN</b><br><b>HOLD</b><br>$\lambda$<br>$\mathsf{K}$<br>$\rightarrow$<br>$\sim$ $\sim$<br>$\cdots$ |                                                                               |
| $\hbox{${\scriptstyle \alpha}$}$<br>Order Nbr.:<br>000003                            | Customer ID:<br>C000000001 - Jersey Central Office Equi                                                 | $\hat{\phantom{a}}$<br><b>Order Total:</b><br>35.00                           |
| Status:<br>Ready for Assignment                                                      | Service:<br>BATTERYREPLACE - Battery Replaceme                                                          | <b>Invoice Nbr.:</b>                                                          |
| 自<br>4/9/2025<br>* Date Created:                                                     | Device:<br>NOKIA3310 - Nokia 3310                                                                       |                                                                               |
| Date Completed:                                                                      | $\varphi$<br>Assignee:                                                                                  |                                                                               |
| Medium<br>Priority:<br>$\vee$                                                        | $ -$<br>December -<br><b>CONTRACTOR</b>                                                                 |                                                                               |
|                                                                                      | $\times$<br>Assign                                                                                      |                                                                               |
| <b>REPAIR ITEMS</b><br>LABOR                                                         | Q<br>* Assignee:                                                                                        |                                                                               |
| $\boxed{\mathbf{X}}$<br>$\mathbb{H}$<br>Ò<br>$\pmb{\times}$<br>$\boldsymbol{+}$<br>0 |                                                                                                         |                                                                               |
| D<br>B 0<br><b>Repair Item Type</b><br><b>Inventory ID</b>                           | CANCEL<br>OK                                                                                            |                                                                               |
| 0<br>ם<br><b>Battery</b><br><b>BAT3310</b><br>≻                                      | 20.00<br>Battery for Nokia 3310                                                                         |                                                                               |
| 0<br><b>Back Cover</b><br>ם<br>!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!              | Back cover for Nokia 3310<br>10.00                                                                      |                                                                               |
|                                                                                      |                                                                                                         |                                                                               |
|                                                                                      |                                                                                                         |                                                                               |
|                                                                                      |                                                                                                         |                                                                               |
|                                                                                      |                                                                                                         |                                                                               |
|                                                                                      |                                                                                                         |                                                                               |
|                                                                                      |                                                                                                         | $\langle \quad \rangle$ $\rangle$<br>$\mathbf{K}$                             |
...
## <span id="page-82-2"></span><span id="page-82-0"></span>**Configuring Field States**

This chapter describes how to configure field states in a screen configuration. For details on configuring field states in a workflow state, see *[Workflow States: General Information](#page-32-3)*.

## <span id="page-82-3"></span><span id="page-82-1"></span>**Field States: General Information**
...
This method allows the developer to provide a BQL expression that determines the proper value. An example of the use of this method is shown in the following code.
...
## <span id="page-83-0"></span>**Field States: Levels of Configuration**
...
| Configuration Type         | DAC | Screen Configura<br>tion | Workflow State | Comment                                                                        |  |
|----------------------------|-----|--------------------------|----------------|--------------------------------------------------------------------------------|--|
| Visibility                 | +   | +                        | +              | The condition on<br>the next level can                                         |  |
| Requirement                | +   | +                        | +              | only narrow what<br>has been defined in                                        |  |
| Availability               | +   | +<br>+                   |                | the previous level.                                                            |  |
| Specify default val<br>ue  | +   | +                        | +              |                                                                                |  |
| Specify combo box<br>value | +   | +                        | +              | On the workflow<br>state level, you can<br>only restrict the set<br>of values. |  |

## <span id="page-85-2"></span><span id="page-85-0"></span>**Implementing Workflow Events**
...
## <span id="page-85-3"></span><span id="page-85-1"></span>**Workflow Events: General Information**
...
Aer you have declared a workflow event, you need to fire it.
...
## <span id="page-88-1"></span><span id="page-88-0"></span>**Workflow Events: To Use an Existing Event**
...
To change the status of the repair work order from *Completed* to *Paid*, you will use an existing workflow event that is fired when the invoice document is assigned the *Closed* state. First, you will explore the code of the *[Invoices](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=0acc9738-f141-4ea0-a2be-f34ea9d1b63a)* (SO303000) form to find the workflow event that is fired. Then, in your extension library, you will create a workflow event handler for this event, bind it to the workflow on the Repair Work Orders (RS301000) form, and implement the transition. You will also implement the Paid workflow state and override the Persist method on the *[Invoices](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=0acc9738-f141-4ea0-a2be-f34ea9d1b63a)* form.
...
- 1. Prepared an instance with the *PhoneRepairShop* customization project and enabled the workflow validation by performing the following activities:
  ...
  - b. *Test Instance for Workflow [Customization:](#page-18-2) To Turn On Workflow Validation*
  - c. *Test Instance for Workflow [Customization:](#page-18-3) To Configure the Instance*
- 2. Prepared the screen configuration and defined the set of workflow states by performing the *[Screen](#page-23-1) [Configuration:](#page-23-1) To Prepare a Screen Configuration for a Form Without a Predefined Workflow* activity.
- 3. Implemented the Completed workflow state by performing the *[Workflow](#page-37-1) States: To Define a Workflow [State](#page-37-1)* activity.

4. Implemented the CreateInvoice action by performing the *Workflow Actions: To Configure the [Conditional](#page-55-2) [Appearance of the Action](#page-55-2)* activity.

## <span id="page-89-0"></span>**Step 1: Exploring the Acumatica ERP Source Code**
...
- 4. Click **Actions > View Business LogicSource**.
...
## <span id="page-89-1"></span>**Step 2: Preparing the Project for Debugging**

To find the workflow event that you can use in a customization project, you can debug the Acumatica ERP source code with breakpoints and see which breakpoint is hit in which scenario. In this step, you will prepare the PhoneRepairShop\_Code for debugging in Visual Studio.

To prepare the PhoneRepairShop\_Code project for the debugging of the Acumatica ERP code, you should do the following:
...
The PDB files were copied to the Files\Bin folder of the Acumatica ERP installation folder (such as C:\Program Files\Acumatica ERP\Files\Bin) during the installation process if the **Install DebuggerTools** check box was selected in the Acumatica ERP Installation wizard. When you create a new instance or update an existing one, these PDB files are copied to the Bin folder of the instance. If you did not select the **Install DebuggerTools** check box during installation, you should remove Acumatica ERP and install it again with the **Install DebuggerTools** check box selected. For details, see *[Acumatica ERP](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=8c7eb99e-31ca-4c1c-8f44-d6960080a450) Installation [On-Premises:](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=8c7eb99e-31ca-4c1c-8f44-d6960080a450) To Install the Acumatica ERP Tools (Optional)*.
...
- d. Save your changes.
- 3. Configure the PhoneRepairShop\_Code project for debugging by doing the following:
  - a. In Visual Studio, open the PhoneRepairShop\_Code solution, which includes both the PhoneRepairShop\_Code project and the website.
...
| <b>Options</b>                                                                                                                                                                                                                                                                                                                                                                              |        |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | 7      | × |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------|---|
| Search Options (Ctrl+E)                                                                                                                                                                                                                                                                                                                                                                     | م      | General                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |        |   |
| <b>b</b> Environment<br><b>Projects and Solutions</b><br>Source Control<br><b>Work Items</b><br><b>Text Editor</b><br>▲ Debugging<br>General<br>.NET / C++ Hot Reload<br>Just-In-Time<br><b>Output Window</b><br>Symbols<br><b>XAML Hot Reload</b><br><b>D. Performance Tools</b><br>.NET Core Debugging with WSL<br>Acuminator<br>Azure Data Lake<br><b>D</b> Azure Service Authentication | ^<br>v | $\vee$ Ask before deleting all breakpoints<br>$\vee$ Break all processes when one process breaks<br>Break when exceptions cross AppDomain or managed/native boundaries (Ma<br>$\vee$ Enable address-level debugging<br>Show disassembly if source is not available<br>$\vee$ Enable breakpoint filters<br>$\vee$ Use the new Exception Helper<br>Enable Just My Code<br>$\vee$ Warn if no user code on launch (Managed only)<br>Suppress JIT optimization on module load (Managed only)<br>Prevent using precompiled images on module load (Managed only, resets on<br>Enable .NET Framework source stepping<br>$\vee$ Step over properties and operators (Managed only)<br>$\vee$ Enable property evaluation and other implicit function calls<br>$\vee$ Call string-conversion function on objects in variables windows<br>Enable source server support<br>$\alpha$ | Cancel |   |

*Figure: The cleared Enable Just My Code check box*

- d. In the **Debugging > Symbols** section, in the**Symbols file (.pdb) locations** list, add the path to the location of the PDB files in your Acumatica ERP instance.
- e. Click **OK**.
- 4. To view the source code of the Release action of the *[Payments and Applications](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=ae844bf4-1aef-42cd-9e2f-49b3ee1bc8d7)* (AR302000) form, open the PX.Objects.AR.ARPaymentEntry graph: In the website folder in the Solution Explorer, select **App\_Data > CodeRepository > PX.Objects > AR > ARPaymentEntry.cs**, and go to the definition of the **Release** action—that is, the IEnumerable Release(PXAdapter adapter) method.
- 5. Add a breakpoint inside the Release method, as shown in the following screenshot.

| ARPaymentEntry.cs $\Rightarrow$ $\times$         |   |                                                                                                                                              |               | ▼ <sup>泰</sup> Solution Explorer  | $-1 \times$                                                                        |
|--------------------------------------------------|---|----------------------------------------------------------------------------------------------------------------------------------------------|---------------|-----------------------------------|------------------------------------------------------------------------------------|
|                                                  |   | - <sup>O</sup> g PX.Objects.AR.ARPaymentEntry<br>- Release(PXAdapter adapter)<br>□ 2 App Data CodeRepository PX.Objects AR ARPaymentEntry.cs | $\frac{1}{2}$ |                                   | <mark>⇔√ ⊡⊡</mark> ⊜ • ⊲ ∣ ⊪ ⊙                                                     |
| !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!<br>1191 |   |                                                                                                                                              |               | Search Solution Explorer (Ctrl+;) | . م                                                                                |
| 1192<br>1193                                     |   | [PXUIField(DisplayName = "Release", MapEnableRights = PXCacheRights.Update, MapViewRights = PXCacheRights.Update)]<br>[PXProcessButton]      |               |                                   | C <sup>#</sup> ARDunningLetterPrint.cs<br>C <sup>#</sup> ARDunningLetterProcess.cs |
| 1194<br>1195                                     |   | [ARMigrationModeDependentActionRestriction(<br>restrictInMigrationMode: false.                                                               |               |                                   | C <sup>#</sup> ARExpiringCardsEng.cs                                               |
| 1196                                             |   | restrictForRegularDocumentInMigrationMode: true.                                                                                             |               |                                   | C <sup>#</sup> ARExpiringCardsProcess.cs<br>C# ARExternalTaxCalc.cs                |
| 1197                                             |   | restrictForUnreleasedMigratedDocumentInNormalMode: true)]<br>0 references                                                                    |               |                                   | C <sup>#</sup> ARFinChargesApplyMaint.cs                                           |
| <b>D1</b> 1198<br>1199                           | 日 | public override IEnumerable Release(PXAdapter adapter)                                                                                       |               |                                   | C <sup>#</sup> ARFinChargesMaint.cs<br>C <sup>#</sup> ARIntegrityCheck.cs          |
| 1200 <sup></sup>                                 |   | $PXCache cache = Document.Cache;$                                                                                                            |               |                                   | C <sup>#</sup> ARInvoiceEntry.cs                                                   |
| 1201                                             |   | List <arreqister> list = new List<arreqister>();</arreqister></arreqister>                                                                   |               |                                   | C <sup>#</sup> ARInvoiceEntry ApprovalWorkflow.                                    |
| 1202                                             | 直 | foreach (ARPayment ardoc in adapter.Get <arpayment>())</arpayment>                                                                           |               |                                   | C <sup>#</sup> ARInvoiceEntry Workflow.cs                                          |
| 1203                                             |   |                                                                                                                                              |               |                                   |                                                                                    |
| 1204                                             | E | if (!(bool)ardoc.Hold)                                                                                                                       |               |                                   | C <sup>#</sup> ARPaymentEntry.cs                                                   |
| 1205                                             |   |                                                                                                                                              |               |                                   | C <sup>#</sup> ARPaymentEntry_ApprovalWorkflor                                     |
| 1206                                             |   | list.Add((ARReqister)cache.Update(ardoc) ?? ardoc);                                                                                          |               |                                   | C <sup>#</sup> ARPaymentEntry workflow.cs                                          |
| 1207                                             |   |                                                                                                                                              |               |                                   | C# ARPaymentEntryDocumentExtensic                                                  |
| 1208<br>1209                                     |   | if $(list.count == 0)$                                                                                                                       |               |                                   | C <sup>#</sup> ARPPDCreditMemoProcess.cs                                           |
| 1210                                             |   |                                                                                                                                              |               |                                   | C# ARPriceClassMaint.cs                                                            |
| 1211                                             |   | throw new PXException(Messages.Document_Status_Invalid);                                                                                     |               |                                   | C <sup>#</sup> ARPriceWorksheetMaint.cs                                            |
| 1212                                             |   |                                                                                                                                              |               |                                   | C# ARPriceWorksheetMaint Workflow.                                                 |
| 1213                                             |   | Save.Press():                                                                                                                                |               |                                   | C# ARPrintlnvoices.cs                                                              |
| 1214                                             |   | PXLongOperation.StartOperation(this, delegate () { ARDocumentRelease.ReleaseDoc(list, false); });                                            |               |                                   | C <sup>#</sup> ARRetainageRelease.cs                                               |
| 1215                                             |   | return list:                                                                                                                                 |               |                                   | C <sup>#</sup> ARSalesPriceMaint.cs                                                |
| 1216                                             |   |                                                                                                                                              |               |                                   |                                                                                    |
...
For details about attaching to the process, see *To Debug the [Customization](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=be6a54e2-0f6c-4566-99f8-aeba6c3944dd) Code*.

- 7. Start debugging by doing the following:
  - a. In Acumatica ERP, open the *[Payments and Applications](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=ae844bf4-1aef-42cd-9e2f-49b3ee1bc8d7)* (AR302000) form.
  - b. Create a payment.
...
## <span id="page-91-1"></span><span id="page-91-0"></span>**Step 3: Exploring and Debugging the Code**

Now that you have prepared the PhoneRepairShop\_Code project for debugging in Visual Studio, you can continue exploring the code of the Release action to find the workflow event that you should use in the customization project. Do the following:
...
| <b>Call Hierarchy</b>                                                                                                                                                       |
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| -⊦ct x l⊓<br>My Solution                                                                                                                                                    |
| CloseInvoiceAndClearBalances(PX.Objects.AR.ARRegister) (PX.Objects.AR.ARReleaseProcess)<br>⊿ ଚ                                                                              |
| △ <■ Calls To 'CloseInvoiceAndClearBalances'                                                                                                                                |
| ● © VerifyAdjustedDocumentAndClose(PX.Objects.AR.ARRegister) (PX.Objects.AR.ARReleaseProcess)                                                                               |
| ▲ △ Calls To 'VerifyAdjustedDocumentAndClose'                                                                                                                               |
| P © ProcessAdjustments(PX.Objects.GL.JournalEntry, PX.Data.PXResultset <px.objects.ar.aradjust>, PX.Objects.AR.ARRegister, PX.Objects.</px.objects.ar.aradjust>             |
| b $\mathcal{D}_+$ ProcessAdjustmentsOnlyAdjusted(PX.Objects.GL.JournalEntry, PX.Data.PXResultset <px.objects.ar.aradjust>) (PX.Objects.AR.ARRelea:</px.objects.ar.aradjust> |
| ▲ © ProcessMigratedDocument(PX.Objects.GL.JournalEntry, PX.Objects.GL.GLTran, PX.Objects.AR.ARRegister, bool, PX.Objects.AR.Customer                                        |
| ▲ △ Calls To 'ProcessMigratedDocument'                                                                                                                                      |
| ▲ © ProcessPayment(PX.Objects.GL.JournalEntry, PX.Objects.AR.ARRegister, PX.Data.PXResult <px.objects.ar.arpayment, px.object<="" td=""></px.objects.ar.arpayment,>         |
| Calls To 'ProcessPayment'                                                                                                                                                   |
| D @ IntegrityCheckProc(PX.Objects.AR.Customer, string) (PX.Objects.AR.ARReleaseProcess)                                                                                     |
| D @ ReleaseDocProc(PX.Objects.GL.JournalEntry, PX.Objects.AR.ARRegister, System.Collections.Generic.List <px.objects.gl.ba< td=""></px.objects.gl.ba<>                      |
| $\triangleright$ $\blacksquare$ Overrides                                                                                                                                   |
| D @ ReleaseInvoice(PX.Objects.GL.JournalEntry, PX.Objects.AR.ARRegister, PX.Data.PXResult <px.objects.ar.arinvoice, px.objects.cn<="" td=""></px.objects.ar.arinvoice,>     |
| $\triangleright$ $\blacksquare$ Overrides                                                                                                                                   |
| $\triangleright$ $\blacksquare$ Overrides                                                                                                                                   |
| D @ VerifyPaymentRoundAndClose(PX.Objects.GL.JournalEntry, PX.Objects.AR.ARRegister, PX.Objects.AR.ARPayment, PX.Objects.AR.Customer, PX.                                   |
| $\triangleright$ $\blacksquare$ Overrides                                                                                                                                   |
|                                                                                                                                                                             |
...
```
RaiseInvoiceEvent(ardoc, 
 ARInvoice.Events.Select(ev => ev.CloseDocument));
```

If you go to the definition of the RaiseInvoiceEvent(ARRegister doc,

PX.Data.WorkflowAPI.SelectedEntityEvent<ARInvoice> invEvent) method, you can find that the CloseDocument workflow event is fired in this method, as shown in the following line of the method.
...
- 5. To make sure that CloseDocument is the workflow event that changes the invoice status to *Closed*, do the following:
  - a. Navigate to the ARInvoiceEntry\_Workflow.cs file, which contains the definition of the workflow for the *[Invoices](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=0acc9738-f141-4ea0-a2be-f34ea9d1b63a)* (SO303000) form.
  - b. In the WithHandlers method, locate the handler for the CloseDocument workflow event. The handler's name is OnCloseDocument.
  - c. Locate the transition from the Open state to the Closed state. Notice that the transition is triggered by the OnCloseDocument workflow event handler, as shown in the following screenshot.
...
- 6. To make sure that the firing of the CloseDocument workflow event in the ARReleaseProcess.CloseInvoiceAndClearBalances method indeed happens when an invoice is fully paid, do the following:
  - a. Add a breakpoint to the line that fires the OnCloseDocument workflow event of the ARReleaseProcess.CloseInvoiceAndClearBalances method.
  - b. Prepare a payment for debugging by doing the following:
    - a. Open the invoice you created in *Workflow Actions: To Configure the Conditional [Appearance](#page-55-2) of the [Action](#page-55-2)* by searching for its number on the *[Invoices](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=0acc9738-f141-4ea0-a2be-f34ea9d1b63a)* (SO303000) form.
    - b. On the form toolbar of the *[Invoices](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=0acc9738-f141-4ea0-a2be-f34ea9d1b63a)* (SO303000) form, click **Remove Hold**.
...
The *[Payments and Applications](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=ae844bf4-1aef-42cd-9e2f-49b3ee1bc8d7)* (AR302000) form opens.

- c. On the form toolbar of the *[Payments and Applications](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=ae844bf4-1aef-42cd-9e2f-49b3ee1bc8d7)* (AR302000) form, click **Remove Hold**, and then click **Release**.
- d. In Visual Studio, notice that a breakpoint in the ARReleaseProcess.CloseInvoiceAndClearBalances method was hit when an invoice was closed.
- e. Stop debugging.

## <span id="page-93-0"></span>**Step 4: Defining the Paid Workflow State (Self-Guided Exercise)**

To define a transition from the Completed workflow state to the Paid workflow state, you first need to define the Paid workflow state. In this step, you will define the Paid state of the workflow as a self-guided exercise. You have learned how to add a workflow state in *Workflow States: To Define a [Workflow](#page-37-1) State*.

While defining the workflow state, you need to use the States.paid class, which you added in *[Step 2: Defining](#page-25-1) [the Set of States of the Workflow](#page-25-1)* of the *Screen [Configuration:](#page-23-1) To Prepare a Screen Configuration for a Form Without a [Predefined Workflow](#page-23-1)* activity. In the Paid workflow state, make the **Customer ID**, **Service ID**, and **Device ID** boxes unavailable.

## <span id="page-94-0"></span>**Step 5: Defining the Workflow Event Handler**
...
2. In the RSSVWorkOrderEntry\_Workflow class, bind the OnCloseDocument workflow event handler to the CloseDocument workflow event in the screen configuration: Aer the AddDefaultFlow method, call the WithHandlers method. In the method, add the OnCloseDocument event handler, as the following code shows.
...
## <span id="page-95-1"></span><span id="page-95-0"></span>**Step 6: Overriding the PerformPersist Method**

The Persist method of any graph saves changes to the database. The

PerformPersist(IPersistPerformer persister) method is a targeted override of the Persist method that offers you full control of the persist process without affecting any of the existing logic. We recommend that you use this method to override the persisting logic of a graph instead of overriding the Persist method directly.
...
In this step, you will override the PerformPersist(IPersistPerformer persister) method of the ARReleaseProcess graph so that the changes to a repair work order that are triggered by the workflow event on the *[Invoices](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=0acc9738-f141-4ea0-a2be-f34ea9d1b63a)* (SO303000) form are saved to the database. Do the following:

- 1. In the PhoneRepairShop\_Code project, create a file named ARReleaseProcess\_Extension.cs based on a C# template.
- 2. In the ARReleaseProcess\_Extension.cs file, declare the ARReleaseProcess\_Extension graph extension, as the following code shows.
...
- 4. In the ARReleaseProcess\_Extension class, add the following code.
...
## <span id="page-96-0"></span>**Step 7: Testing the Transition**
...
- 4. On the *[Invoices](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=0acc9738-f141-4ea0-a2be-f34ea9d1b63a)* (SO303000) form, open the invoice created in the previous instruction.
...
| <b>Repair Work Orders</b><br>000005 - Battery Replacement                                                       |                                                                  |           | <b>T</b> NOTES | <b>FILES</b>     | <b>CUSTOMIZATION</b> | TOOLS $\blacktriangleright$ |
|-----------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------|-----------|----------------|------------------|----------------------|-----------------------------|
| $\circ$ $\sim$<br>冐<br>$\Box$<br>!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!<br>$^{+}$<br>$\Omega$<br>$\leftarrow$ | $-1<$<br>$\sim$ $\sim$<br>$\rightarrow$<br>$\lambda$<br>$\cdots$ |           |                |                  |                      |                             |
| $\varphi$<br>Order Nbr.:<br>000005                                                                              | Customer ID:<br>C000000001 - Jersey Central Office Equip         |           | Order Total:   |                  | 35.00                | $\sim$                      |
| Status:<br>Paid                                                                                                 | BATTERYREPLACE - Battery Replaceme<br>Service:                   |           | Invoice Nbr.:  | <b>INV000050</b> |                      |                             |
| ₿<br>* Date Created:<br>4/28/2025                                                                               | Device:<br>NOKIA3310 - Nokia 3310                                |           |                |                  |                      |                             |
| Date Completed: 4/28/2025                                                                                       | Andrews, Michael<br>Assignee:                                    | $\varphi$ |                |                  |                      |                             |
| Medium<br>Priority:<br>$\checkmark$                                                                             | Description:<br>Battery replacement, Nokia 3310                  |           |                |                  |                      |                             |
|                                                                                                                 |                                                                  |           |                |                  |                      |                             |
| <b>REPAIR ITEMS</b><br>LABOR                                                                                    |                                                                  |           |                |                  |                      |                             |
| $\boxtimes$<br>Ò<br>$\vdash$<br>$\pm$<br>$\times$<br>0                                                          |                                                                  |           |                |                  |                      |                             |
| <b>Repair Item Type</b><br>D<br><b>Inventory ID</b><br>8.                                                       | <b>Description</b>                                               | Price     |                |                  |                      |                             |
| $\Box$<br>0<br>≻<br><b>Battery</b><br><b>BAT3310</b>                                                            | Battery for Nokia 3310                                           | 20.00     |                |                  |                      |                             |
| $\bf \omega$<br>$\Box$<br><b>Back Cover</b><br>!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!                         | Back cover for Nokia 3310                                        | 10.00     |                |                  |                      |                             |
|                                                                                                                 |                                                                  |           |                |                  |                      |                             |
|                                                                                                                 |                                                                  |           |                |                  |                      |                             |
|                                                                                                                 |                                                                  |           |                |                  |                      |                             |
|                                                                                                                 |                                                                  |           |                |                  |                      |                             |
...
## <span id="page-97-1"></span><span id="page-97-0"></span>**Workflow Events: To Create a Workflow Event**
...
- c. *Test Instance for Workflow [Customization:](#page-18-3) To Configure the Instance*
- 2. Prepared the screen configuration and defined the set of workflow states by performing the *[Screen](#page-23-1) [Configuration:](#page-23-1) To Prepare a Screen Configuration for a Form Without a Predefined Workflow* activity.
- 3. Implemented the PendingPayment and ReadyForAssignment workflow states by performing the *[Step 2: Adding the PendingPayment Workflow State \(Self-Guided Exercise\)](#page-69-3)* and *[Step 3: Defining the Workflow](#page-80-2) State and the Transition [\(Self-Guided](#page-80-2) Exercise)* prerequisite steps.
- 4. Implemented the CreateInvoice action by performing the *Workflow Actions: To Configure the [Conditional](#page-55-2) [Appearance of the Action](#page-55-2)* prerequisite activity.

## <span id="page-98-0"></span>**Step 1: Creating a Custom Field**

In Acumatica ERP, a user can create a payment for an invoice by clicking the **Pay** button or command on the *[Invoices](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=0acc9738-f141-4ea0-a2be-f34ea9d1b63a)* (SO303000) form. When the payment is created, it is opened on the *[Payments and Applications](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=ae844bf4-1aef-42cd-9e2f-49b3ee1bc8d7)* (AR302000) form.

The workflow for the *Battery Replacement* service involves one payment, which is made upon completion of the work. Conversely, the workflow for the *Liquid Damage* service involves both a prepayment before the repair work is assigned and a final payment aer the work is complete.
...
To display and modify the prepayment percentage on the *[Payments and Applications](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=ae844bf4-1aef-42cd-9e2f-49b3ee1bc8d7)* (AR302000) form, you need to add the **Prepayment Percent** box to the form. Complete the following general tasks:
...
4. Add a box for the UsrPrepaymentPercent field to the Summary area of the *[Payments and Applications](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=ae844bf4-1aef-42cd-9e2f-49b3ee1bc8d7)* (AR302000) form. On the *[Customized Screens](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=98b095c8-14d5-477a-9fc3-cc7c57fee3cd)* page, the location of the element appears as shown in the following screenshot.

| <b>Customization Project Editor</b>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |                                               |                                                                                                                                                                                             |                                                                                                                                                                                                                                                                                                                                                                                                                                                         |                                                                          |                        | <b>Back</b>      | Reload |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------|------------------------|------------------|--------|
| Source Control<br>Publish<br><b>Extension Library</b><br>File                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |                                               |                                                                                                                                                                                             |                                                                                                                                                                                                                                                                                                                                                                                                                                                         |                                                                          |                        |                  |        |
| PhoneRepairShop<br>Screen Editor: AR302000 (Payments and Applications)<br>٠                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |                                               |                                                                                                                                                                                             |                                                                                                                                                                                                                                                                                                                                                                                                                                                         |                                                                          |                        |                  |        |
| n<br>$\overline{\phantom{a}}$ SCREENS<br><b>EDIT ASPX</b><br>$\curvearrowleft$<br><b>PREVIEW CHANGES</b><br>▶ AR302000<br>$\circ$<br>$\Box$<br>▶ IN202500<br>▶ RS101000<br>» @ DataSource: ARPaymentEntry<br>▶ RS201000<br>style<br>▶ RS202000<br>← <i>f</i> Form: Document<br>▶ RS203000<br>▶ <i>□</i> Column<br>▶ RS301000<br>▶ <i>同</i> Column<br>Data Access<br>▶ <i>□</i> Column<br>Code<br>- <i>f</i> Column<br><b>Files (23)</b><br><b>III Prepayment Percent</b><br>Generic Inquiries (3)<br>▶ <i>□</i> Tab<br>Reports<br>▶ <i>□</i> Dialogs<br><b>Dashboards</b><br>Site Map (6)<br>Database Scripts (13)<br><b>System Locales</b><br>Import/Export Scenarios<br>Shared Filters (1)<br>Access Rights (8)<br><b>Wikis</b><br><b>Web Service Endpoints</b><br><b>Analytical Reports</b><br><b>Push Notifications</b><br><b>Business Events</b><br><b>Mobile Application</b><br><b>User-Defined Fields</b><br>Webhooks<br><b>Connected Applications</b> | $\cdots$<br>Ò<br>Override<br>٠<br>٠<br>٠<br>٠ | $\mathbb{H}$<br>$\Box$<br>$\Box$<br>☑<br>☑<br>$\Box$<br>$\Box$<br>$\Box$<br>$\Box$<br>$\Box$<br>$\Box$<br>0<br>$\Box$<br>$\Box$<br>$\Box$<br>$\Box$<br>$\Box$<br>$\Box$<br>$\Box$<br>$\Box$ | <b>LAYOUT PROPERTIES</b><br><b>ATTRIBUTES</b><br><b>EVENTS</b><br>$\boldsymbol{\nabla}$<br>Property<br><b>Base Properties</b><br>CommitChanges<br><b>DataField</b><br>ID<br>Size<br><b>SkinID</b><br>SmartSuggestionMode<br><b>Ext Properties</b><br>AlreadyLocalized<br>AutoCallBack<br><b>DisableSpellcheck</b><br><b>DisplayFormat</b><br>Enabled<br>LabelWidth<br>LinkCommand<br>LocalizationInfo<br>SuppressLabel<br>SyncStateWithCommand<br>Width | <b>ADD CONTROLS</b><br>Value<br>UsrPrepaymentPercent<br>CstPXNumberEdit1 | <b>ADD DATA FIELDS</b> | <b>VIEW ASPX</b> |        |
...
## <span id="page-99-0"></span>**Step 2: Deriving the Value of the Field**
...
To populate the UsrPrepaymentPercent field of the ARPayment DAC extension when a payment is created, you will use the FieldDefaulting event. Do the following:
...
## <span id="page-100-1"></span><span id="page-100-0"></span>**Step 3: Exploring the Acumatica ERP Source Code**

In this step, you will explore the source code of the *[Invoices](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=0acc9738-f141-4ea0-a2be-f34ea9d1b63a)* (SO303000) and *[Payments and Applications](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=ae844bf4-1aef-42cd-9e2f-49b3ee1bc8d7)* (AR302000) forms of Acumatica ERP. You will explore the code of these forms to learn the field names and methods you need to use in order to determine where and when to fire the event that triggers the transition from the PendingPayment state to the ReadyForAssignment state.
...
To calculate this percentage, you need the outstanding amount of the invoice and the original amount of the invoice. These values are displayed in the **Balance** and **Amount** boxes, respectively, of the *[Invoices](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=0acc9738-f141-4ea0-a2be-f34ea9d1b63a)* (SO303000) form. Thus, to calculate the percentage, you should learn the field names of these boxes by doing the following:

- 1. In Acumatica ERP, open the *[Invoices](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=0acc9738-f141-4ea0-a2be-f34ea9d1b63a)* (SO303000) form.
...
If you do not see the **Amount** box on the form, you need to select the**Validate Document Totals on Entry** check box on the *[Accounts Receivable Preferences](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=f7b52067-5299-45e8-b601-485cd709f58b)* (AR101000) form, open or refresh the *[Invoices](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=0acc9738-f141-4ea0-a2be-f34ea9d1b63a)* (SO303000) form, and then perform this instruction.
...
## <span id="page-101-1"></span><span id="page-101-0"></span>**Step 4: Declaring the Workflow Event**
...
3. In the RSSVWorkOrderEntry\_Workflow class, bind the OnInvoiceGotPrepaid workflow event handler to the InvoiceGotPrepaid workflow event in the screen configuration: In the lambda expression for the WithHandlers method, add the handler, as the following code shows.
...
## <span id="page-102-0"></span>**Step 5: Firing the Event**

As you learned in *[Step 3: Exploring the Acumatica ERP Source Code](#page-100-1)* of this activity, you need to override the UpdateBalances method to fire the event that triggers the transition from the PendingPayment workflow state to the ReadyForAssignment workflow state. However, you should first calculate the prepaid percentage value based on the values of the **Balance** and **Amount** boxes of an invoice on the *[Invoices](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=0acc9738-f141-4ea0-a2be-f34ea9d1b63a)* (SO303000) form. These values, which are available in an ARRegister record, have been calculated in the base UpdateBalances method.
...
To fire the workflow event that triggers the transition between workflow states, add the following code to the ARReleaseProcess\_Extension class of the PhoneRepairShop\_Code project.
...
## <span id="page-104-0"></span>**Step 6: Testing the Transition**
...
The *[Payments and Applications](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=ae844bf4-1aef-42cd-9e2f-49b3ee1bc8d7)* (AR302000) form opens. Notice that the **Prepayment Percent** box contains *10.00*, which has been copied from the Repair Work Order Preferences (RS101000) form.

- 7. On the *[Payments and Applications](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=ae844bf4-1aef-42cd-9e2f-49b3ee1bc8d7)* (AR302000) form, change the existing values to the following values, as shown in the following screenshot:
...
| <b>Payments and Applications</b><br>Payment - Jersey Central Office Equip |               |                |                                              |                                    |                                        |               |        |                                            |                  |                                  |                | <b>P</b> NOTES             | <b>ACTIVITIES</b>   | <b>FILES</b>    | <b>CUSTOMIZATION</b>            | TOOLS $\blacktriangledown$ |
|---------------------------------------------------------------------------|---------------|----------------|----------------------------------------------|------------------------------------|----------------------------------------|---------------|--------|--------------------------------------------|------------------|----------------------------------|----------------|----------------------------|---------------------|-----------------|---------------------------------|----------------------------|
| 霌<br>周<br>$\overline{\phantom{0}}$                                        | $\Omega$      | ┿              | $\circ$ $\sim$<br>甸                          | $\overline{\mathsf{K}}$            | $\left\langle \right\rangle$           | $\rightarrow$ | $\geq$ | <b>REMOVE HOLD</b>                         |                  | $\cdots$                         |                |                            |                     |                 |                                 |                            |
| Type:                                                                     | Payment       | $\checkmark$   | Customer:                                    |                                    |                                        |               |        | C000000001 - Jersey Central Office Equit 2 |                  | Payment Amo                      |                | 50.00 ⑦                    | Prepayment Percent: |                 |                                 | $\sim$<br>5.00             |
| Reference Nbr.:                                                           | <new></new>   | $\mathfrak{Q}$ |                                              | Payment Meth CHECK - Check Payment |                                        |               |        |                                            | Q                | Applied to Doc                   |                | 3.00                       |                     |                 |                                 |                            |
| Status:                                                                   | On Hold       |                |                                              | Card/Account                       |                                        |               |        |                                            |                  | Applied to Ord                   |                | 0.00                       |                     |                 |                                 |                            |
| * Application Date: 4/28/2025                                             |               | $\Box$         |                                              | * Cash Account:                    |                                        |               |        |                                            | $\varphi$        | Available Bala                   |                | 47.00                      |                     |                 |                                 |                            |
| * Application Pe 04-2025                                                  |               | $\mathcal{Q}$  |                                              |                                    |                                        |               |        |                                            |                  | Write-Off Amo                    |                | 0.00                       |                     |                 |                                 |                            |
| Payment Ref.:                                                             |               |                |                                              |                                    |                                        |               |        |                                            |                  | Finance Charg                    |                | 0.00                       |                     |                 |                                 |                            |
|                                                                           |               |                |                                              |                                    |                                        |               |        |                                            |                  |                                  | Deducted Cha   | 0.00                       |                     |                 |                                 |                            |
|                                                                           |               |                |                                              |                                    |                                        |               |        |                                            |                  |                                  |                |                            |                     |                 |                                 |                            |
|                                                                           |               |                | Description:                                 |                                    |                                        |               |        |                                            |                  |                                  |                |                            |                     |                 |                                 |                            |
| <b>DOCUMENTS TO APPLY</b><br>$\times$<br>O                                |               |                | <b>SALES ORDERS</b><br><b>LOAD DOCUMENTS</b> | <b>AUTO APPLY</b>                  | <b>APPLICATION HISTORY</b><br>$\vdash$ | $\boxtimes$   |        | <b>FINANCIAL</b>                           | <b>APPROVALS</b> |                                  | <b>CHARGES</b> |                            |                     |                 |                                 |                            |
| E 0<br>n                                                                  | <b>Branch</b> |                | Doc. Type                                    |                                    | *Reference Nbr.                        |               |        | <b>Amount Paid</b>                         |                  | Cash<br><b>Discount</b><br>Taken | Amount Code    | Write-Off Write-Off Reason | Date                | <b>Due Date</b> | Cash<br><b>Discount</b><br>Date | Cros                       |
| ☑<br>$\Box$<br>$\epsilon$ 0                                               | SOFT          |                | Invoice                                      |                                    | <b>INV000051</b>                       |               |        | 3.00                                       |                  | 0.00                             | 0.00           |                            | 4/28/2025           | 5/28/2025       | 4/28/2025                       | 1.0000                     |
...
| <b>Repair Work Orders</b><br>000004 - Liquid Damage                      |                                                               |                           | $\Box$ NOTES     | <b>FILES</b> | <b>CUSTOMIZATION</b>                               | TOOLS $\blacktriangledown$ |
|--------------------------------------------------------------------------|---------------------------------------------------------------|---------------------------|------------------|--------------|----------------------------------------------------|----------------------------|
| 품<br>$\Box$<br>$\Omega$ +<br>û<br>$\leftarrow$                           | $D \times K$<br>$\langle \rangle$<br>$\lambda$<br><b>HOLD</b> | <b>ASSIGN</b><br>$\cdots$ |                  |              |                                                    |                            |
| ρ<br>Order Nbr.:<br>000004                                               | Customer ID:<br>C000000001 - Jersey Central Office Equip      | Order Total:              | 50.00            |              |                                                    | $\hat{\phantom{a}}$        |
| Ready for Assignment<br>Status:                                          | LIQUIDDAMAGE - Liquid Damage<br>Service:                      | Invoice Nbr.:             | <b>INV000051</b> |              |                                                    |                            |
| ₿<br>* Date Created:<br>4/9/2025                                         | Device:<br>NOKIA3310 - Nokia 3310                             |                           |                  |              |                                                    |                            |
| Date Completed:                                                          | Assignee:                                                     | $\varphi$                 |                  |              |                                                    |                            |
| Medium<br>Priority:<br>$\checkmark$                                      | Liquid Damage, Nokia 3310<br>Description:                     |                           |                  |              |                                                    |                            |
| <b>REPAIR ITEMS</b><br>LABOR                                             |                                                               |                           |                  |              |                                                    |                            |
| $\boxtimes$<br>$\times$<br>$\left  \rightarrow \right $<br>$+$<br>0<br>Ò |                                                               |                           |                  |              |                                                    |                            |
| Repair Item Type<br><b>Inventory ID</b><br>8.                            | Description                                                   | Price                     |                  |              |                                                    |                            |
| $\geq 0$<br>D<br>Battery<br><b>BAT3310</b>                               | Battery for Nokia 3310                                        | 20.00                     |                  |              |                                                    |                            |
| 0<br>$\Box$<br><b>Battery</b><br><b>BAT3310EX</b>                        | Extended Battery for Nokia 3310                               | 30.00                     |                  |              |                                                    |                            |
|                                                                          |                                                               |                           |                  |              |                                                    |                            |
|                                                                          |                                                               |                           |                  |              |                                                    |                            |
|                                                                          |                                                               |                           |                  |              |                                                    |                            |
|                                                                          |                                                               |                           |                  |              |                                                    |                            |
|                                                                          |                                                               |                           |                  |              |                                                    |                            |
|                                                                          |                                                               |                           |                  |              | $\overline{\mathbf{K}}$<br>$\langle \quad \rangle$ | $>$                        |
|                                                                          |                                                               |                           |                  |              |                                                    |                            |

*Figure: The repair work order with the Ready for Assignment status*

## <span id="page-106-2"></span><span id="page-106-0"></span>**Customizing a Predefined Workflow**
...
## <span id="page-106-1"></span>**Workflow Customization: General Information**
...
## <span id="page-107-2"></span><span id="page-107-0"></span>**Workflow Customization: To Add an Action to an Existing Workflow**

This activity will walk you through the process of adding an action to an existing workflow.

#### **Story**

To quickly continue working on a repair work order aer an invoice has been prepaid, a user needs to be able to invoke a command that opens the corresponding repair work order from the *[Invoices](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=0acc9738-f141-4ea0-a2be-f34ea9d1b63a)* (SO303000) form. You will customize the workflow on the *[Invoices](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=0acc9738-f141-4ea0-a2be-f34ea9d1b63a)* (SO303000) form to add the**View Repair Work Order** command and its underlying action, which opens the repair work order. The**View Repair Work Order** command should be displayed under a new category called **Repair Work Orders**.
...
- 1. Prepared an instance with the *PhoneRepairShop* customization project and enabled the workflow validation by performing the following activities:
  ...
  - b. *Test Instance for Workflow [Customization:](#page-18-2) To Turn On Workflow Validation*
- 2. Prepared the screen configuration and defined the set of workflow states by performing the *[Screen](#page-23-1) [Configuration:](#page-23-1) To Prepare a Screen Configuration for a Form Without a Predefined Workflow* activity.
- 3. Performed the *[Workflow](#page-88-1) Events: To Use an Existing Event* prerequisite activity to implement the Paid workflow state.

## <span id="page-107-1"></span>**Step 1: Adding a Graph Action**

In this step, you will create an extension of the graph of the *[Invoices](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=0acc9738-f141-4ea0-a2be-f34ea9d1b63a)* (SO303000) form. In the extension, you will add an action that opens a repair work order. Do the following:

- 1. Learn the name of the graph where the action should be added:
  - a. On the *[Invoices](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=0acc9738-f141-4ea0-a2be-f34ea9d1b63a)* (SO303000) form, click Ctrl + Alt, and click the Summary area of the form.
  - b. In the **Element Properties** dialog box, notice the name in the **Business Logic** box: SOInvoiceEntry.

2. In the PhoneRepairShop\_Code project, create an extension of the SOInvoiceEntry graph, as the following code shows.
...
Use Acuminator to suppress the *[PX1016](https://github.com/Acumatica/Acuminator/blob/master/docs/diagnostics/PX1016.md)* error in a comment. In this activity, for simplicity, the extension is always active.
...
## <span id="page-108-1"></span><span id="page-108-0"></span>**Step 2: Adding a Workflow Extension**

In this step, you will create an extension for the workflow defined for the *[Invoices](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=0acc9738-f141-4ea0-a2be-f34ea9d1b63a)* (SO303000) form. Do the following:

1. Find the name of the class that defines the workflow for the *[Invoices](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=0acc9738-f141-4ea0-a2be-f34ea9d1b63a)* (SO303000) form. To do this, explore the contents of the PX.Objects/SO/Workflow folder of the Acumatica ERP source code. There you can find the class you need to extend: SOInvoiceEntry\_Workflow, which is an extension of the SOInvoiceEntry graph.
...
- 2. In the Workflows folder of the PhoneRepairShop\_Code project, create the SOInvoiceRepairOrder\_Workflow.cs file.
- 3. In the SOInvoiceRepairOrder\_Workflow.cs file, in the PhoneRepairShop namespace, define the SOInvoiceRepairOrder\_Workflow class as the following code shows.
...
In the code above, you have defined an extension of the SOInvoiceRepairOrder\_Workflow class. As a second parameter of the extension, you have specified the graph of the *[Invoices](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=0acc9738-f141-4ea0-a2be-f34ea9d1b63a)* (SO303000) form. In the extension, you have overridden the Configure(PXScreenConfiguration) method, which initializes the screen configuration, and declared the static Configure(WorkflowContext) method where you will update the workflow.
...
## <span id="page-109-0"></span>**Step 3: Defining a Workflow Action**

The **View Repair Work Order** command should be displayed in its own category on the More menu of the *[Invoices](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=0acc9738-f141-4ea0-a2be-f34ea9d1b63a)* (SO301000) form. The action is displayed when the invoice is prepaid—that is, when the invoice has the *Open* status. In this step, you will define a custom category, add the action to the workflow, and make it available in the Open state of the workflow.

Do the following:

1. In the SOInvoiceRepairOrder\_Workflow.cs file, define the class that contains information for custom categories, as the following code shows.
...
3. Aer the definitions of the category and the action, update the default workflow, as the following code shows.
...
In the code above, you have updated the screen configuration by calling the UpdateScreenConfigurationFor method. In the lambda expression for the method, you have

updated the default workflow by calling the UpdateDefaultFlow method. In the lambda expression

for the UpdateDefaultFlow method, you have added the viewOrder action to the Open state of the workflow.
...
## <span id="page-111-0"></span>**Step 4: Testing the New Action**
...
- 3. On the *[Invoices](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=0acc9738-f141-4ea0-a2be-f34ea9d1b63a)* (SO303000) form, open the invoice that you have created for the repair work order.
...
| <b>Invoices</b><br>Invoice INV000051 - Jersey Central Office Equip                                                                                                                                                                                                        |                                                                                                                                                                          | <b>P</b> NOTES<br><b>ACTIVITIES</b>                                                                                                                                                                                                                                      | TOOLS $\blacktriangleright$<br><b>CUSTOMIZATION</b><br><b>FILES</b>                             |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------|
| 圖<br>$\Box$<br>$\Omega$<br>$\pm$<br>$\leftarrow$                                                                                                                                                                                                                          | ۰ ۵<br>间<br>$\overline{\mathsf{K}}$<br>$\lambda$<br>$\rightarrow$<br>≺                                                                                                   | $\cdots$                                                                                                                                                                                                                                                                 |                                                                                                 |
| Invoice<br>Type:<br>$\checkmark$<br>Reference Nbr.:<br>INV000051 Q<br>Status:<br>Open<br>Date:<br>4/28/2025<br>Post Period:<br>04-2025<br>Customer Ord<br>Project/Contract: X - Non-Project Code.<br>Description:<br><b>DETAILS</b><br><b>TAXES</b><br><b>COMMISSIONS</b> | C000000001 - Jersey<br>Customer:<br>Terms:<br>30D - Net 30 days<br>* Due Date:<br>5/28/2025<br>自<br>* Cash Discount 4/28/2025<br>自<br><b>FREIGHT</b><br><b>FINANCIAL</b> | Printing and Emailing<br>Processing<br><b>Remove Hold</b><br><b>Print Invoice</b><br>Hold<br><b>Email Invoice</b><br>Release<br>Other<br>Pay<br><b>Recalculate Prices</b><br>Corrections<br>Reports<br><b>Correct Invoice</b><br><b>AR Edit</b><br><b>Cancel Invoice</b> | $\sim$                                                                                          |
| Ò<br>$\times$<br>$\mathscr{Q}$<br>ADD ITEMS                                                                                                                                                                                                                               | ADD ORDER<br>ADD SO LINE                                                                                                                                                 | Write Off<br>Repair Work Orders<br><b>Reclassify GL Batch</b><br><b>View Repair Work Order</b>                                                                                                                                                                           |                                                                                                 |
| <b>B</b> 0<br>n.<br>*Branch<br><b>Shipment Nbr.</b><br>$\mathbf{0}$<br>D SOFT<br>SOFT<br>$\omega$<br>ם                                                                                                                                                                    | Order Nbr.<br>Order<br>Type<br>On Hand -2.00 PIECE, Available -2.00 PIECE, Available for Shipping -2.00 PIECE                                                            | Approval<br><b>Credit Hold</b><br><b>Remove Credit Hold</b>                                                                                                                                                                                                              | Quantity UOM<br>1.00 PIECE<br>PIECE<br>1.00<br>$\mathbf{K}$<br>>1<br>$\rightarrow$<br>$\langle$ |
...
- 6. Return to the *[Invoices](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=0acc9738-f141-4ea0-a2be-f34ea9d1b63a)* (SO303000) form.
...
## <span id="page-112-0"></span>**Implementing Composite States**
...
## <span id="page-112-1"></span>**Composite Workflow States: General Information**
...
In the code above, the HoldToBalance composite workflow state is declared. The composite state includes the following wokflow states:
...
- A transition from one workflow state included in a composite state to the workflow state defined aer it. To define this transition, in the Add method for the transition, you call the ToNext method.
...
In the code above, the pendingApproval workflow state has been added to the HoldToBalance composite workflow state and placed aer the hold workflow state. Three transitions have been added from the pendingApproval workflow state.

## <span id="page-115-0"></span>**Composite Workflow States: To Update a Composite State**
...
In the extension of the predefined workflow for the *[Invoices](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=0acc9738-f141-4ea0-a2be-f34ea9d1b63a)* (SO303000) form, you will implement an action (and the corresponding button on the form toolbar and command on the More menu) that will trigger a transition from the new state. You will also add a nested workflow state, specify a condition that the system will use to skip this state, and then add a transition from this state to the next nested workflow state.
...
- 1. Prepared an instance with the *PhoneRepairShop* customization project and enabled the workflow validation by performing the following activities:
  ...
  - b. *Test Instance for Workflow [Customization:](#page-18-2) To Turn On Workflow Validation*
- 2. Prepared the screen configuration and defined the set of workflow states by performing the *[Screen](#page-23-1) [Configuration:](#page-23-1) To Prepare a Screen Configuration for a Form Without a Predefined Workflow* activity.
- 3. Created an extension of the predefined workflow for the *[Invoices](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=0acc9738-f141-4ea0-a2be-f34ea9d1b63a)* (SO303000) form, as described in the *Workflow [Customization:](#page-107-2) To Add an Action to an Existing Workflow* prerequisite activity.

## <span id="page-116-0"></span>**Step 1: Investigating the Source Code**

To begin customizing the predefined workflow, you need to investigate how the composite workflow state is defined in it. In *[Step 2: Adding a Workflow Extension](#page-108-1)* of the *Workflow [Customization:](#page-107-2) To Add an Action to an [Existing Workflow](#page-107-2)* activity, you learned that the workflow for the *[Invoices](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=0acc9738-f141-4ea0-a2be-f34ea9d1b63a)* (SO303000) form is defined in the SOInvoiceEntry\_Workflow class and that the states of the workflow are defined in the ARDocStatus class.

You will investigate the source code of the SOInvoiceEntry\_Workflow class by doing the following:

- 1. In Visual Studio, in the *SmartFix\_T270* website project, go to App\_Data/CodeRepository/ PX.Objects/SO/Workflow, and open the SOInvoiceEntry\_Workflow.cs file.
- 2. In the SOInvoiceEntry\_Workflow class, locate the AddSequence<State.HoldToBalance> method call. This call defines the HoldToBalance composite workflow state. Notice the order in which the nested workflow states are defined, and locate the creditHold workflow state. Aer the creditHold workflow state, you can see the pendingPrint workflow state, which will be the next state for the new Postponed state of the workflow.
- 3. Go to the definition of the ARDocStatus class, and note how the workflow states are defined.
- 4. For the purpose of adding a new status value, learn the name of the field that holds the status value on the *[Invoices](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=0acc9738-f141-4ea0-a2be-f34ea9d1b63a)* (SO303000) form by using the *[Element Inspector](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=5f9d2d33-1a33-4edd-8629-3100d2020335)*. This field is ARInvoice.Status.

## <span id="page-117-0"></span>**Step 2: Extending the ARDocStatus class**

Before you add the Postponed state to the workflow, you need to add a string constant and class to the extension of the ARDocStatus class. You also need to add a corresponding value to the field that holds the record's status on the *[Invoices](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=0acc9738-f141-4ea0-a2be-f34ea9d1b63a)* (SO303000) form. Do the following:

1. In the SOInvoiceRepairOrder\_Workflow.cs file, extend the ARDocStatus class by adding the following code.
...
2. Add a combo box value to the**Status** box on the *[Invoices](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=0acc9738-f141-4ea0-a2be-f34ea9d1b63a)* (SO303000) form by calling the WithFieldStates method in the lambda expression for the UpdateScreenConfigurationFor method, as the following code shows.
...
## <span id="page-117-1"></span>**Step 3: Adding the ApproveDiscount Action**
...
1. In the SOInvoiceRepairOrder\_Workflow class, define a string constant whose value will be used as the display name for the approveDiscount action, as the following code shows.

public const string ApproveDiscount = "Approve Discount";

2. In the static Configure method of the SOInvoiceRepairOrder\_Workflow class, add the following code.
...
## <span id="page-118-0"></span>**Step 4: Adding the Skip Condition**

The Postponed workflow state should be skipped if no discount is being applied to the invoice—that is, if the **Document Discounts** box is *0.0* on the *[Invoices](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=0acc9738-f141-4ea0-a2be-f34ea9d1b63a)* (SO303000) form. In this step, you will define this condition by doing the following:

- 1. On the *[Invoices](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=0acc9738-f141-4ea0-a2be-f34ea9d1b63a)* (SO303000) form, learn the field name of the **Document Discounts** box by using the *[Element](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=5f9d2d33-1a33-4edd-8629-3100d2020335) [Inspector](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=5f9d2d33-1a33-4edd-8629-3100d2020335)* tool. The field name is CuryDiscTot. The field is defined in the ARInvoice DAC.
- 2. In the SOInvoiceRepairOrder\_Workflow class, define the condition, as the following code shows.
...
## <span id="page-118-1"></span>**Step 5: Adding the Postponed Workflow State to the Composite State**

To add the Postponed workflow state to the composite state, do the following:

1. In the SOInvoiceRepairOrder\_Workflow class, add the Postponed workflow state in the WithFlowStates method, as shown in the following code.
...
- Added the Postponed workflow state aer the CreditHold workflow state
...
## <span id="page-119-0"></span>**Step 6: Adding the Transition**
...
1. In the SOInvoiceRepairOrder\_Workflow class, in the lambda expression for the UpdateDefaultFlow method, add the following code.
...
## <span id="page-120-0"></span>**Step 7: Testing the Transition**
...
- 3. On the *[Invoices](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=0acc9738-f141-4ea0-a2be-f34ea9d1b63a)* (SO303000) form, open the created invoice.
...
| <b>Invoices</b><br>Invoice INV000052 - Jersey Central Office Equip                                                                            |                                                             |                               |                                                                   |                                    |                                |                                        |                                            |                                                                                                     |                |                                                                                           |                                                                       | <b>PNOTES</b> | <b>ACTIVITIES</b> | <b>FILES</b>                                                                             | <b>CUSTOMIZATION</b>          | TOOLS $\blacktriangleright$    |
|-----------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------|-------------------------------|-------------------------------------------------------------------|------------------------------------|--------------------------------|----------------------------------------|--------------------------------------------|-----------------------------------------------------------------------------------------------------|----------------|-------------------------------------------------------------------------------------------|-----------------------------------------------------------------------|---------------|-------------------|------------------------------------------------------------------------------------------|-------------------------------|--------------------------------|
| 周<br>$\Box$<br>$\leftarrow$                                                                                                                   | $\Omega$                                                    |                               | O.<br>侕<br>$\checkmark$                                           | $\overline{\mathsf{K}}$            | $\left\langle \right\rangle$   | $\geq$<br>$\sum$                       |                                            | APPROVE DISCOUNT                                                                                    |                |                                                                                           | $\cdots$                                                              |               |                   |                                                                                          |                               |                                |
| Type:<br>Reference Nbr.:<br>Status:<br>* Date:<br>* Post Period:<br>Customer Ord<br>* Project/Contract: X - Non-Project Code.<br>Description: | Invoice<br>INV000052 Q<br>Postponed<br>4/29/2025<br>04-2025 | $\checkmark$<br>自<br>$\Omega$ | Customer:<br>* Terms:<br>* Due Date:<br>* Cash Discount 4/29/2025 |                                    | 30D - Net 30 days<br>5/29/2025 | 自<br>户                                 | C000000001 - Jersey Central Office Equit 2 | $\mathcal{Q}$<br>$\circ$                                                                            |                | De<br>Lir<br>Do<br>Fn<br>Та<br>B <sub>z</sub><br>!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! | Processing<br>Remove Hold<br>Hold<br>Release<br>Pay<br>Corrections    |               | Other             | <b>Print Invoice</b><br>Email Invoice<br><b>Recalculate Prices</b><br>Approve Discount ● | Printing and Emailing         | $\hat{\phantom{a}}$            |
| <b>ODETAILS</b><br>Ò                                                                                                                          | <b>TAXES</b><br>$\times$                                    | <b>ADD ITEMS</b>              | <b>COMMISSIONS</b>                                                | <b>FREIGHT</b><br><b>ADD ORDER</b> |                                | <b>FINANCIAL</b><br><b>ADD SO LINE</b> | <b>ADDRESSES</b><br>ADD RETURN LINE        |                                                                                                     | <b>APPLICA</b> | <b>RES</b>                                                                                | Correct Invoice<br>Cancel Invoice<br>Write Off<br>Reclassify GL Batch |               | <b>AR Edit</b>    | Reports                                                                                  |                               |                                |
| $\mathbf{0}$<br>n.<br>*Branch<br>$\mathbf{0}$<br>$D$ SOFT<br>n<br>SOFT<br><b>D</b><br>n.<br>SOFT                                              |                                                             | <b>Shipment Nbr.</b>          |                                                                   | Order<br><b>Type</b>               |                                | Order Nbr.                             |                                            | <b>Inventory ID</b><br><b>BAT3310</b><br>!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!<br><b>CONSULT</b> |                | Tra<br>Ba<br>Ba<br>C(                                                                     | Approval<br><b>Credit Hold</b><br><b>Remove Credit Hold</b>           |               |                   | Repair Work Orders                                                                       | <b>View Repair Work Order</b> |                                |
| On Hand -2.00 PIECE, Available -2.00 PIECE, Available for Shipping -2.00 PIECE                                                                |                                                             |                               |                                                                   |                                    |                                |                                        |                                            |                                                                                                     |                |                                                                                           |                                                                       |               |                   |                                                                                          | $\mathbb{R}$<br>$\langle$     | $\rightarrow$<br>$\rightarrow$ |
...
- 8. On the *[Invoices](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=0acc9738-f141-4ea0-a2be-f34ea9d1b63a)* (SO303000) form, open the created invoice.
...
| <b>Cases</b><br>000008 - Providing support services                                                                                                                                                                                                                                                                                                                                                                                                         |                                                                                                                            |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |                                                                    | MOT                                           | The operation has<br>completed. | $\times$ |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------|-----------------------------------------------|---------------------------------|----------|
| 周<br>而<br>$\Box$<br>Ĥ<br>$\Omega$<br>$\leftarrow$<br>$\checkmark$                                                                                                                                                                                                                                                                                                                                                                                           | $\overline{\mathsf{K}}$<br>$\left\langle \right\rangle$<br>$\rightarrow$                                                   | $\lambda$<br><b>NEW</b><br>$\cdots$                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |                                                                    |                                               |                                 |          |
| 000008<br>Case ID:<br>Date Reported:<br>10/26/2023 11:59 AM<br>Last Activity Date:<br>SLA:<br><b>Closing Date:</b><br>10/26/2023 12:00 PM<br><b>ADDITIONAL INFO</b><br><b>DETAILS</b><br><b>ATTRIBUTES</b><br><b>BUSINESS ACCOUNT DETAILS</b><br>C000000052 - Streamray Incorporated<br><b>Business Account:</b><br>Contract:<br><b>BILLING</b><br><b>Billable</b><br>Manual Override<br><b>Billable Time:</b><br>0:00<br><b>Billable Overtime:</b><br>0:00 | Class ID:<br>$\varphi$<br><b>Business Account:</b><br>Contact:<br>Owner:<br>Subject:<br><b>ACTIVITIES</b><br>$\mathscr{Q}$ | PRODSUPINC - Product Support - Incide 2<br>C000000052 - Streamray Incorporated<br>Andrews Michael<br><b>Processing Results</b><br>The document is successfully processed<br>◙<br>$\checkmark$ The Take Case action has completed.<br>$\checkmark$ The Open action has completed.<br>$\checkmark$ The Close action has completed.<br>! The Release action has failed. The system executed<br>other actions because the Stop on Error check box<br>had been cleared for this action.<br>Error: The Release button is disabled.<br>The View Invoice action has not been executed<br>because it is not used in the Closed workflow state. | Status:<br>Reason:<br>0<br>0<br>Severity:<br>Priority:<br>$\times$ | <b>Closed</b><br>Resolved<br>Medium<br>Medium |                                 | $\sim$   |
|                                                                                                                                                                                                                                                                                                                                                                                                                                                             |                                                                                                                            | OK                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |                                                                    |                                               |                                 |          |

#### *Figure: The dialog box during action execution*

For details on implementing action sequences in Workflow UI, see *[Action Configuration: Action Sequences](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=e61fabdf-523b-4558-894e-6177219b18c3)* in the *[Workflow UI Guide](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=8ce8c907-9854-4bbd-b8f2-557703b9812f)*.
...
- 3. In the lambda expression for the Add method, you configure the sequence by using the following methods:
  - AfterAction (required): Specifies the triggering action (the action aer which the sequence should be executed). A developer can specify either an action from the graph or an action defined by using Workflow API.
...
• WithFieldAssignments (optional): Assigns the fields of a dialog box that is configured for the second action of the sequence (specified in the RunAction method). The assignment is performed aer the first action (specified in the AfterAction method) is executed.
...
## <span id="page-123-0"></span>**Action Sequences: To Define an Action Sequence**

The following activity will walk you through the process of defining an action sequence.

#### **Story**

Suppose that when a user clicks the **Close** command on the *[Cases](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=a492a091-9649-4826-bcc3-dccdf8765efd)* (CR306000) form, you need to execute the actions that correspond to the following commands on the form:

- **Release** to release the case
- **View Invoice** if the case is billable (that is, if the **Billable** check box is selected on the **CRM Info** tab of the *[Cases](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=a492a091-9649-4826-bcc3-dccdf8765efd)* form)
...
Then you will extend the default workflow for the *[Cases](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=a492a091-9649-4826-bcc3-dccdf8765efd)* (CR306000) form and define the action sequences in the extension. In order to define an action sequence for more than two actions, you need to define an action sequence for each pair. Thus, you will first define an action sequence for the Close and Release actions, and then an action sequence for the Release and View Invoice actions.

#### **System Preparation**

Before you begin, you should make sure that you have configured your instance of Acumatica ERP, as described in the *[Preparing an Instance for Workflow Customization](#page-16-4)* chapter.

You also need to create an extension library for the instance. For details, see *To Create an [Extension](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=f7e12f94-c8be-4013-8990-9341161bb252) Library*.

#### **Step 1: Investigate the Internal Names of Elements on the Cases Form**

To define a sequence of existing actions, you need to learn the internal names of these actions in the graph of the *[Cases](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=a492a091-9649-4826-bcc3-dccdf8765efd)* (CR306000) form, as well as other relevant internal names. Do the following:

1. Open the *[Cases](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=a492a091-9649-4826-bcc3-dccdf8765efd)* form.
...
- 5. In the website project of the Visual Studio solution, find the source code of the PX.Objects.CR namespace, and find the class that defines the code of the workflow for the *[Cases](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=a492a091-9649-4826-bcc3-dccdf8765efd)* form: The CaseWorkflow class is located in App\_Data/CodeRepository/PX.Objects/CR/Workflows/ CaseWorkflow.cs.

#### **Step 2: Implement the First Action Sequence**

To implement the first action sequence to be executed, do the following:

- 1. In the extension library, create a C# file named CaseWorkflow\_Extension.cs.
- 2. In the file, extend the class that implements the workflow for the *[Cases](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=a492a091-9649-4826-bcc3-dccdf8765efd)* (CR306000) form, as shown in the following code.
...
To implement an action sequence containing the release and viewInvoice actions, you need to add a separate sequence aer the first one. Because the viewInvoice action should be executed only if the case is billable, you need to define a condition and specify it in the action sequence. Do the following:

- 1. Define a condition that is true when the case is billable.
  - a. In the CaseWorkflow\_Extension class, define the Conditions class with the condition.
...
```
using static PX.Data.WorkflowAPI.BoundedTo<PX.Objects.CR.CRCaseMaint,
...
2. In the WithActionSequences method, add the second sequence aer the sequence defined in the previous step. Specify the IsBillable condition in the AppliesWhen method.
...
1. Open the *[Cases](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=a492a091-9649-4826-bcc3-dccdf8765efd)* (CR306000) form.

To make sure that the workflow has been modified correctly, note that the More button is displayed and the toolbar buttons have connotations. If you suspect an error, you can check the workflow output on the**System Events** tab of the *[System Monitor](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=7569f087-0001-4164-a9cc-dab2a64d781a)* form. For details, see *Test Instance for Workflow [Customization:](#page-18-2) To Turn On Workflow Validation*.
...
| Cases<br>000010 - Test Sequence                              |                                             | $\Box$ NOT<br>◯ Executing. Press to abort<br>00:00:00                                      |                             |
|--------------------------------------------------------------|---------------------------------------------|--------------------------------------------------------------------------------------------|-----------------------------|
| $\Box$<br>$\mathbb{E}$<br>$\leftarrow$                       | $D - n$<br>$\Omega$ +<br>$-1<$<br><b>Ky</b> | <b>TAKE CASE</b><br>CLOSE  <br>$\lambda$<br>$\rightarrow$<br>$\cdots$                      | CANCEL                      |
| Case ID:                                                     | 000010                                      | <b>Processing Results</b><br>$\times$<br>$\mathscr{O}$<br>Reported On:<br>$\triangleright$ | $\Box$<br>4/10/2024 4:29 AM |
| * Case Class:                                                | SERVCONS - Services Consulting              | $\mathscr{O}$<br>Severity:<br>$\mathbf{z}_{\mathbf{w}}$<br>Processing the document         | Medium<br>$\checkmark$      |
| Status:                                                      | Open                                        | Priority:                                                                                  | Medium<br>$\checkmark$      |
| Reason:                                                      | In Process                                  |                                                                                            |                             |
| * Subject:                                                   | <b>Test Sequence</b>                        |                                                                                            |                             |
| <b>DETAILS</b><br><b>CRM INFO</b><br>$CRM$ $-$<br>Workgroup: | <b>ATTRIBUTES</b><br><b>ACTIVITIES</b>      |                                                                                            |                             |
| <b>ENTITLEMENT</b>                                           | Active                                      |                                                                                            |                             |
| Contract:<br><b>BILLING</b>                                  |                                             | OK                                                                                         |                             |
|                                                              | <b>Billable</b>                             |                                                                                            |                             |
|                                                              | Manual Override                             |                                                                                            |                             |
| <b>Billable Time:</b>                                        | 0:00                                        |                                                                                            |                             |

*Figure: The system performing a long-running operation*

Aer the sequence is completed, in the **Processing Results** dialog box, note the list of actions that have been performed: **Close**, **Release**, and **View Invoice**, as shown in the following screenshot. The *[Invoices and](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=5e6f3b27-b7af-412f-a40a-1d4f4be70cba) [Memos](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=5e6f3b27-b7af-412f-a40a-1d4f4be70cba)* (AR301000) form is opened in a new tab with the invoice created for the case.

| Cases<br>000010 - Test Sequence<br>$\Xi$<br>$\Box$<br>$\leftarrow$       | $\mathbb{Q}$ $\sim$<br>面<br>$-1<$<br>$\Omega$<br>$\sim$ $\sim$<br>$^{+}$                        | $\lambda$ $\cdots$<br>$\rightarrow$                                                                                                                                                     |          |                 |   | $\Gamma$ NOTI<br>$\sim$<br>completed.                | $\times$<br>The operation has                              |
|--------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------|-----------------|---|------------------------------------------------------|------------------------------------------------------------|
| Case ID:<br>Case Class:<br>Status:<br>Reason:<br>Subject:                | 000010<br><b>SERVCONS - Services Consulting</b><br>Released<br>Resolved<br><b>Test Sequence</b> | <b>Processing Results</b><br>$\subset$<br>The document is successfully processed<br>◎<br>$\checkmark$ The Close action has completed.<br>$\checkmark$ The Release action has completed. | $\times$ | Equi $\sqrt{2}$ | 0 | Reported On:<br>Severity:<br>Priority:<br>Closed On: | 4/10/2024 4:29 AM<br>Medium<br>Medium<br>4/10/2024 4:30 AM |
| <b>DETAILS</b><br>CRM ____________________________________<br>Workgroup: | <b>CRM INFO</b><br><b>ATTRIBUTES</b><br><b>ACTIVITIES</b>                                       | $\checkmark$ The View Invoice action has completed.                                                                                                                                     |          |                 |   |                                                      |                                                            |
| <b>ENTITLEMENT.</b><br>Contract:<br><b>BILLING -</b>                     | $\Box$ Active                                                                                   | OK                                                                                                                                                                                      |          |                 |   |                                                      |                                                            |
| <b>Billable Time:</b>                                                    | <b>Billable</b><br>Manual Override<br>0:00                                                      |                                                                                                                                                                                         |          |                 |   |                                                      |                                                            |

*Figure: The list of performed actions*

7. In the **Processing Results** dialog box, click **OK**.

## <span id="page-128-0"></span>**Defining Workflows with a Workflow Identifying Field**
...
## <span id="page-128-1"></span>**Workflow-Identifying Fields: General Information**
...
The form can have only one default workflow, which is defined with the AddDefaultFlow method. For details, see *Screen [Configuration:](#page-23-1) To Prepare a Screen Configuration for a Form Without a Predefined [Workflow](#page-23-1)*.
...
You can define workflow-identifying field of the first and second level. For details on defining a workflow-identifying field of the second level, see *[Workflow-Identifying Fields of the Second Level:](#page-137-2) [General Information](#page-137-2)*.
...
3. Inside the Add method, you define workflow states and transitions, as described in *[Defining Workflow States](#page-32-2)* and *[Implementing](#page-63-2) Transitions*.
...
## <span id="page-129-1"></span><span id="page-129-0"></span>**Workflow-Identifying Fields: To Add a Workflow for a Value of the Workflow-Identifying Field**
...
- Quickly while the customer awaits in the phone repair shop. In this case, the workflow can skip most of the traditional states and be paid right aer it is created. So the workflow can have only three states (OnHold, Completed, Paid) and direct transitions from one to another.
- In a few days while the order awaits the assigned employee. In this case, the standard default workflow can be applied.
- In a few weeks because some of the required items are out of stock. In this case, the workflow might have an additional state, AwaitingDelivery, in addition to standard states of the workflow described in *[Customization Description](#page-12-1)*.

These ways of processing a repair work order are defined by the **OrderType** box which can have one of the following values:
...
In this activity, you will define a workflow for the *Simple* value of the **OrderType** box. The workflow is shown in the following diagram.

![](_page_130_Figure_4.jpeg)

#### *Figure: Workflow for the Simple order type*

When the repair work order is created, it gets the *On Hold* status. Then a user can click the **Complete** action on the form toolbar, which changes the order to *Completed*. Aer that, a user can click **Create Invoice** on the form toolbar, which initiates creation of an invoice for this repair work order. When the invoice is created, a user can release and pay it on the *[Invoices](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=0acc9738-f141-4ea0-a2be-f34ea9d1b63a)* (SO303000) and *[Payments and Applications](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=ae844bf4-1aef-42cd-9e2f-49b3ee1bc8d7)* (AR302000) forms respectively. As soon as the invoice is fully paid, the repair work order status should be changed to *Paid*.

#### **Process Overview**

You will first add the UsrOrderType field to the RSSVWorkOrder DAC and respective database table. The field will hold the type of a repair work order and will be used on the Repair Work Orders (RS301000) form. Then, in the screen configuration for the Repair Work Orders (RS301000) form, you will specify this field as a workflowidentifying field. Then, you will add a workflow for the *Simple* value of the UsrOrderType field.
...
- 3. Performed the following prerequisite activities:
  - a. *Workflow Actions: To Implement an Action with Field [Assignments](#page-53-1)*
  - b. *Workflow Actions: To Configure the Conditional [Appearance](#page-55-2) of the Action*
  - c. *[Workflow](#page-88-1) Events: To Use an Existing Event*

## <span id="page-131-1"></span><span id="page-131-0"></span>**Step 1: Adding the OrderType Field and Corresponding Box to the UI**
...
- 1. Add the UsrOrderType field to the RSSVWorkOrder database table by doing the following:
  - a. In the Customization Project Editor, open the *[Database Scripts](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=f7e4fcdf-02dd-4812-b561-1179da5dd30d)* page.
  - b. On the More menu, click **Add Custom Column toTable**.
  - c. In the **Add Custom Column toTable** dialog box which opens, specify the following values:
    - **Table**: *RSSVWorkOrder*
...
- **Length**: 2
- d. Click **OK**.
- e. Publish the customization project to apply the database script.
...
Use Acuminator to suppress the *[PX1016](https://github.com/Acumatica/Acuminator/blob/master/docs/diagnostics/PX1016.md)* error in a comment. In this course, for simplicity, the extension is always active.

- 5. Rebuild the PhoneRepairShop\_Code project.
- 6. Add the **OrderType** box to the Repair Work Orders (RS301000) form by doing the following:
  - a. In the Customization Project Editor, open**Screens > RS301000** page.
  - b. In the control tree, select the first column in the **Form: WorkOrders** node.
  - c. On the **Add Data Fields** tab, select the UsrOrderType field and click **Create Controls**. The **OrderType** field appears as the first element of the selected column in the control tree.
  - d. On the **Layout Properties** tab, for the **CommitChanges** property, select *True*.

Once a new value is selected in the box, the system will apply the workflow that corresponds to the selected value.

- e. Save your changes and publish the customization project.
- f. Open the Repair Work Orders (RS301000) form and make sure the **OrderType** box is displayed in the Summary area of the form as a drop down control.

## <span id="page-133-0"></span>**Step 2: Specifying the Workflow-Identifying Field in the Workflow**
...
1. In the extension library, create an extension of the RSSVWorkOrderEntry\_Workflow class as shown in the following code.
...
2. In the RSSVWorkOrderEntry\_Workflow\_Extension class, define the set of constant string values and corresponding classes for the value of the UsrOrderType field which as the following code shows.
...
3. In the RSSVWorkOrderEntry\_Workflow\_Extension class, override the Configure method as the following code shows.
...
## <span id="page-134-0"></span>**Step 3: Adding a Workflow for the Specific Value of the Workflow-Identifying Field**

In this step, you will add a workflow for the *Simple* value of the **OrderType** box. This workflow has three workflow states (which are OnHold, Completed, and Paid) and the following transitions:
...
You will add these workflow states and transitions to the screen configuration in the extension of the RSSVWorkOrderEntry\_Workflow class.

You do not need to add actions and event handlers used in this workflow because they are already added in the original screen configuration defined in the RSSVWorkOrderEntry\_Workflow class.

To add the new workflow, do the following in the static Configure method of the RSSVWorkOrderEntry\_Workflow\_Extension class:

1. In the lambda expression for the UpdateScreenConfigurationFor method, aer calling the FlowTypeIdentifierIs method, call the WithFlows method and add a workflow for the *Simple* value of the UsrOrderType field as shown in the following code.
...
3. In the private static getSimpleBehavior method, aer the call of the WithFlowStates method, define the transitions by using the WithTransitions method as the following code shows.
...
## <span id="page-136-0"></span>**Step 4: Testing the Workflow**
...
- 2. In the **OrderType** box, select *Simple*
...
- 6. On the *[Invoices](https://help-2025r1.acumatica.com/Help?ScreenId=ShowWiki&pageid=0acc9738-f141-4ea0-a2be-f34ea9d1b63a)* (SO303000) form, open the created invoice.
- 7. On the form toolbar, click **Remove Hold**, and then **Release**.
...
- 10.Open the repair work order that you have created in this step. Make sure that its status has changed to *Paid*.

## <span id="page-137-0"></span>**Using Workflow-Identifying Fields of the Second Level**

## <span id="page-137-2"></span><span id="page-137-1"></span>**Workflow-Identifying Fields of the Second Level: General Information**
...
| <b>Default Workflow</b> |                               |                               |
|-------------------------|-------------------------------|-------------------------------|
|                         | Type Identifier: Value1       | Type Identifier: Value2       |
|                         | <b>States</b>                 | States                        |
|                         |                               |                               |
|                         | Transitions                   | Transitions                   |
|                         |                               |                               |
|                         | Workflow1_1                   | Workflow2_1                   |
|                         | Subtype Identifier: SubValue1 | Subtype Identifier: SubValue1 |
|                         | States_delta                  | States_delta                  |
|                         | Transitions_delta             | Transitions delta             |
|                         | Workflow1_2                   | Workflow2_2                   |
|                         | Subtype Identifier: SubValue2 | Subtype Identifier: SubValue2 |
|                         | States_delta                  | States_delta                  |
|                         | Transitions_delta             | Transitions_delta             |
|                         |                               | $\cdots$                      |
|                         | Workflow1_N                   | Workflow2_N                   |
|                         | Subtype Identifier: SubValueN | Subtype Identifier: SubValueN |
|                         | States_delta                  | States_delta                  |
...
## <span id="page-139-0"></span>**Workflow-Identifying Fields of the Second Level: To Define a Workflow**
...
- Prepared an instance with the *PhoneRepairShop* customization project and enabled the workflow validation by performing the prerequisite activities in the *[Preparing an Instance for Workflow Customization](#page-16-4)* chapter
- Defined the default workflow for the Repair Work Orders (RS301000) form according to the customization description in *[Company Story and Customization Description](#page-8-1)*
- Defined a workflow identifying field for the Repair Work Orders (RS301000) form as described in *[Workflow-](#page-129-1)Identifying Fields: To Add a Workflow for a Value of the [Workflow-Identifying](#page-129-1) Field*
...
To add the field, use the same instructions as described in *Step 1: Adding the OrderType Field and [Corresponding](#page-131-1) [Box to the UI](#page-131-1)*.

#### **Step 2: Specify the Workflow-Identifying Field of the Second Level**

In this step, you will specify the UsrBehavior field as the workflow-identifying field of the second level in the extension of RSSVWorkOrderEntry\_Workflow class. You will do it using the FlowSubTypeIdentifierIs method. Do the following:

1. In the RSSVWorkOrderWorkflow\_Extension class which you defined in *[Workflow-Identifying Fields:](#page-129-1) To Add a Workflow for a Value of the [Workflow-Identifying](#page-129-1) Field*, define the set of constant string values and corresponding classes for the value of the UsrBehavior field which will later be used as values of the workflow-identifying field of the second level.

![](_page_140_Picture_22.jpeg)

You can do it the same way as you did for the UsrOrderType field.

2. In the Configure method, aer the call to the FlowTypeIdentifierIs method, call the FlowSubTypeIdentifierIs method and specify the UsrBehavior field as the type parameter as shown in the following code.
